...
export default function Dashboard() {
  ...
  async function continuaConversazione(id: string) {
    nuovaChatManualeRef.current = false; // scelta esplicita dal cassetto → sync di nuovo ok
...
Rispondi in italiano, in modo concreto e operativo. Se ti servono dati che non vedi qui, elenca quali.`;
  ...
  // Resta acceso finché non scrive o sceglie una chat dal cassetto (no timer — regressione 18/7).
    ...
    <div className="min-h-screen flex flex-col">
      ...
      {(chatFluttuante || workerFull) && (
        ...
        >
          ...
          <div
            className={workerFull ? "relative flex flex-col flex-1 min-h-0 w-full sm:max-w-5xl sm:mx-auto sm:border-l sm:border-r overflow-hidden" : "relative flex flex-col flex-1 min-h-0 overflow-hidden"}
            style={workerFull ? { borderColor: "var(--border)" } : undefined}
          >
          {/* Solo chiudi + ingrandisci — niente barra titolo Worker */}
