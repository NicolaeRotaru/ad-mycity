  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="t-eti mt-0.5">Salute, auto-analisi del lavoro, e la radiografia di sé: come si controlla, impara e diventa più brava.</p>
      </div>

      {/* Salute della macchina (cuore + organi) */}
      <CuoreMacchina />
      <StatoMacchina />

      {/* 🩻 Radiografia di sé (il nuovo cuore: la macchina analizza la propria architettura) */}
      <RadiografiaDiSe />

      {/* Auto-coscienza esistente: auto-analisi del lavoro · apprendimento · auto-miglioramento */}
      <AutoCoscienza />
    </div>
  );
}
