...
const RIGHE: Riga[] = [
  ...
  { q: "I report, le radiografie e i piani (es. il §6 del piano di bonifica)", area: "memoria", sub: "archivio", dove: "Memoria › Consegne" },
  ...
  { q: "Le decisioni passate e lo stato dell'azienda", area: "memoria", sub: "storico-decisioni", dove: "Memoria › Decisioni" },
  ...
  { q: "Il codice e i file del repo", area: "memoria", sub: "archivio/github", dove: "Memoria › GitHub" },
];
