...
> - ✅ **0.3** Riconciliazione payout (dai campi reali, senza Stripe) · ✅ **2.1** Acquisizione CAC/LTV:CAC · ✅ **2.5** Cassa/runway/burn → **Ondata 2 COMPLETA**
> - 🚀 **Ondata 3 (analisi) COMPLETA:** ✅ **3.1** radar bidirezionale IN/OUT · ✅ **3.2** catene indirette · ✅ **3.4** reputazione · ✅ **3.6** grafo d'influenza (mappa IN→MyCity→OUT + catene) · ✅ **scaffolding monitoraggio** (18 fonti + `monitora.md` + handoff) che copre 3.3/3.5. ⏭️ resta solo l'**accensione** dello scheduler da parte di builder (cron/n8n, nessuna chiave a pagamento) per renderlo *continuo*.
> - 🏁 **Stato macchina:** Ondate 0,1,2 complete (salvo 0.2 rinviato + CAC-canale che aspetta le UTM); Ondata 3 analisi completa. La macchina di analisi totale è in piedi.
> - 📌 **Insight dai dati veri (27/6):** 258 prodotti a catalogo ma ~0 ordini pagati (4 order_items totali); 4 clienti, 0 referral; 1 ordine COD payout `AWAITING_REMITTANCE` → il collo di bottiglia è la **domanda**, non l'offerta. Conferma la tesi dell'analisi dei Piani.
