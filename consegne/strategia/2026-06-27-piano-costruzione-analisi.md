...
> - 🚀 **Ondata 3 in corso:** ✅ **3.1** radar bidirezionale IN/OUT (100 IN + 11 leve OUT) · ✅ **3.2** catene indirette (7) · ✅ **3.4** brand/reputation (scheda «Reputazione») · ✅ **scaffolding monitoraggio web** (`radar-fonti.json` 18 fonti + `monitora.md` + handoff builder) → 3.3 competitor + 3.5 calendario-città sono coperti dal motore (girano appena builder schedula). ⏭️ resta **3.6 grafo d'influenza** + l'**accensione** dello scheduler (builder: cron/n8n, nessuna chiave a pagamento).
