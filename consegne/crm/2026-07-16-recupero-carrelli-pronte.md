...
data: 2026-07-16 11:07
fonte: Supabase REST live (`abandoned_carts` + `profiles` + `user_carts` + `coupons`) · `verifica-sensori.mjs` 11:06 (`supabase_rest=ok`)
...
# Recupero carrelli — pacchetto pronto (16/7 11:07 · playbook worker)

> **Verifica live 2026-07-16 11:07.** REST marketplace leggibile (`supabase_rest=ok`, `verifica-sensori.mjs` 11:06).
> `abandoned_carts`: **4 record** (invariati vs 15/7). `ordini_tot=1` (unico ordine CANCELED 3/7, user `9262fa38…`).
...
|---|---|---|
| Record `abandoned_carts` | **4** | REST 16/7 11:07 |
...
| Coupon attivi | `BENVENUTO10` (10%, primo ordine) · `SPED5` (€5 sopra €25) | `coupons` REST 16/7 11:07 |

## Classificazione (16/7 11:07)

| # | user_id | Nome | Ruolo | Totale | Fermo da | Inviabile? |
|---|---------|------|-------|--------|----------|------------|
| 1 | `57494b3e-fd67-4379-8b9c-90e40e39ff06` | samir? | buyer | **€10,00** | ~707h (16/6) | **SÌ** — unico cliente reale |
| 2 | `33333333-3333-3333-3333-aaaaaaaa0001` | Assistenza MyCity | admin | €7,95 | ~328h (2/7) | SKIP — admin test |
| 3 | `11111111-1111-1111-1111-cccccccc0001` | Casa Linda | seller | €17,80 | ~690h (17/6) | SKIP — seed demo |
| 4 | `c0b240c0-2a86-4218-9d0f-5154f08ff929` | Pane Quotidiano | seller | €13,90 | ~709h (16/6) | SKIP — auto-test negoziante |
...
mentre PQ non evade. **Contesto 16/7:** Venerdì Piacentini domani 17/7 — gate ancora aperto finché PQ non evade.
