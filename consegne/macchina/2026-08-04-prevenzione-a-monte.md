...
aveva proposto — se le dai l'ok là, dille che AR-518 e AR-519 sono già presi qui, o nasce un doppione.
...
- Scheda: AR-519 (in corso — si chiude al primo scatto dal vivo dopo il cablaggio) · nata da AR-518.
...
- Prove: `node --test cervello/test/mano-fermata.test.mjs cervello/test/lezioni-su-misura.test.mjs
  ...
  `node cervello/non-vacuita.mjs --difetti AR-519`.
