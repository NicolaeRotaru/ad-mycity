...
- Scheda: AR-518 (chiusa, verifica eseguibile) · lezione L-2026-0804-551 con gate attivo.
...
- Prove: `node --test cervello/test/collaudo.test.mjs` (17) · 191 verdi sui file toccati ·
  2 mutazioni in `cervello/mutanti.json` verificate rosse con `node cervello/non-vacuita.mjs --difetti AR-518`.
