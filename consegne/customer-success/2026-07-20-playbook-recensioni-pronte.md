...
origine: playbook:recensioni (worker 20/7 11:27)
---

# Recensioni post-consegna — aggiornamento 20/7 11:27

> **Verifica live 2026-07-20 11:27.** North Star = 0 consegne completate.
...
|---|---|---|
| Ordini totali in DB | **1** | `orders` REST 20/7 11:27 |
...
| Totale | €19,05 COD |
| user_id | `9262fa38-225c-4a25-bce6-a37503327bb4` |

Inviare «grazie + recensione» a un ordine annullato sarebbe inventato → blocco corretto.

## Messaggi già in AZIONI-PRONTE (ri-timestampati 20/7 11:27)
