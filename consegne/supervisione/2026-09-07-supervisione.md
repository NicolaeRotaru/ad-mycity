...
data: 2026-09-07 08:28
---

# 🛡️ Supervisione negozi & prodotti — 2026-09-07 08:28
...
```bash
# 4 righe · elenco ID: consegne/supervisione/ids/2026-09-07-products-condition-nuovo.json · batch annullabile: sup-2026-09-07-products-condition
for id in $(node -e "console.log(require('./consegne/supervisione/ids/2026-09-07-products-condition-nuovo.json').join('\n'))"); do \
  BATCH_ID=sup-2026-09-07-products-condition AZIONI_LIVE=1 node cervello/marketplace.mjs aggiorna products "$id" '{"condition":"nuovo"}'; \
done
# Annullare tutto il gruppo:  AZIONI_LIVE=1 node cervello/marketplace.mjs annulla-batch sup-2026-09-07-products-condition
```
