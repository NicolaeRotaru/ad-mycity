...
data: 2026-07-08 20:20
---

# 🛡️ Supervisione negozi & prodotti — 2026-07-08 20:20
...
```bash
# 252 righe · elenco ID: consegne/supervisione/ids/2026-07-08-products-condition-nuovo.json
for id in $(node -e "console.log(require('./consegne/supervisione/ids/2026-07-08-products-condition-nuovo.json').join('\n'))"); do \
...
- **Comando pronto** (dopo il tuo ok, con `AZIONI_LIVE=1`):
```bash
# 242 righe · elenco ID: consegne/supervisione/ids/2026-07-08-products-unit-pezzo.json
for id in $(node -e "console.log(require('./consegne/supervisione/ids/2026-07-08-products-unit-pezzo.json').join('\n'))"); do \
