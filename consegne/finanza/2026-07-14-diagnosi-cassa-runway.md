...
tipo: diagnosi
reparto: finanza
origine: sentinella cassa_sconosciuta (87 giri)
---
...
**Stripe funziona e legge 0€ in cassa; manca solo che tu dica quanto spendiamo al mese (`BURN_MENSILE_EUR`) — senza quel numero il runway resta «sconosciuto» da 87 giri.**

---

## Cosa abbiamo verificato (03:25, VPS)
...
| Runway | **sconosciuto** | 87 giri consecutivi senza calcolo |
...
*Fonti: `cassa-runway.json` 14/7 03:25 · `verifica-sensori.mjs` exit 0 · `sensori-cecita.json` · briefing 14/7 · regola AR-039/AR-016*
