...
## Esiti
- 2026-07-19 18:56 · Render build fallito post-#214 — Nicola «Non ha fatto il deploy?» · atteso: spiegare merge vs online + causa build · reale: Auto-Deploy ok, build crashato orders/page TS (debito radiografia); fix branch `fix/render-build-orders-page`; coda #197 · L-315 · #render #deploy #build-failed #esito
