# ⚠️ 15 — Rischi & Compliance (cosa può affondare MyCity)

> Risk management e compliance Italia/UE, giugno 2026. 🟢 con fonte · 🟡 da validare con professionista · 🔴 criticità grave.
> Collega a: [[05-Decisioni-Aperte]] · [[Pagamenti e Payout Venditori]] · [[Verifica e KYC Venditori]] · [[Gestione Rider e Pool Fattorini]]
...
✅ **Mitigazione:** lancio **iper-localizzato** (centro), 8-15 botteghe-ancora, "do things that don't scale" (fondatore consegna), domanda concentrata su fasce orarie. → vedi [[08-Domanda-Primi-Clienti]].
...
✅ **Mitigazione:** ricavo a più leve (commissione + fee consegna al cliente + ordine minimo + abbonamento); **scontrino alto** (spesa settimanale) + densità. Misurare il **margine di contribuzione per consegna**, non il GMV. → vedi [[09-Ricerca-Mercato-e-Numeri|§4]].
