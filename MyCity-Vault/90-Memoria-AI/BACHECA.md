...
| 5 | 🛡️ **Guardiani e sensori — il sistema immunitario** | Quello che impedisce alla macchina di raccontarti una bugia. | 392 script (85 nelle sottocartelle) · 11 sensori · 451 test + 29 prove bash |
...
> 📁 Dove: `cervello/*.mjs` — girano prima che l'AI scriva una riga · 📏 Quanto: 392 script (85 nelle sottocartelle) · 11 sensori · 451 test + 29 prove bash
