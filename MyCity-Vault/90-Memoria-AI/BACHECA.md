...
| --- | --- | --- | --- |
| 1 | 🖥️ **Il Pannello — la faccia** | Quello che vedi e dove firmi. | 244 file · 38.192 righe · 15 aree · 77 rotte |
| 2 | 🦾 **Il worker e il VPS — le braccia** | L'unico pezzo che esegue davvero, 24 ore su 24. | 2003 righe · 14 servizi · 12 timer |
| 3 | 🧠 **L'AD — la testa** | Chi decide, delega e scrive in memoria. | mansionario di 495 righe · giro di 1927 righe · 21 manuali |
...
| 5 | 🛡️ **Guardiani e sensori — il sistema immunitario** | Quello che impedisce alla macchina di raccontarti una bugia. | 387 script (85 nelle sottocartelle) · 11 sensori · 410 test + 29 prove bash |
| 6 | 📚 **La memoria — quello che ricorda** | Dove vive tutto ciò che la macchina sa e ha deciso. | 9 cartelle · 41 fatti-chiave · 45 file di auto-coscienza |
...
> 📁 Dove: `pannello/` — ospitato su Vercel · 📏 Quanto: 244 file · 38.192 righe · 15 aree · 77 rotte
...
> 📁 Dove: `CLAUDE.md` + i documenti in `cervello/` · 📏 Quanto: mansionario di 495 righe · giro di 1927 righe · 21 manuali
...
- **5.5 I test e la CI (410 + 29 + 4)** — I test girano a ogni giro, non solo quando qualcuno se li ricorda: un test che nessuno esegue è un file, non una rete.
...
> 📁 Dove: `cervello/*.mjs` — girano prima che l'AI scriva una riga · 📏 Quanto: 387 script (85 nelle sottocartelle) · 11 sensori · 410 test + 29 prove bash
...
- **6.4 L'auto-coscienza (45 file)** — Difetti, calibrazione, apprendimento, chi è reale e chi è una scelta ragionata, salute, costi, pagella.
...
> 📁 Dove: `MyCity-Vault/` — più il database della Cabina · 📏 Quanto: 9 cartelle · 41 fatti-chiave · 45 file di auto-coscienza
