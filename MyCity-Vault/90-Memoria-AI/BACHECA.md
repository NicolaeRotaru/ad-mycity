...
| 3 | 🧠 **L'AD — la testa** | Chi decide, delega e scrive in memoria. | mansionario di 495 righe · giro di 2092 righe · 21 manuali |
...
| 5 | 🛡️ **Guardiani e sensori — il sistema immunitario** | Quello che impedisce alla macchina di raccontarti una bugia. | 391 script (85 nelle sottocartelle) · 11 sensori · 451 test + 29 prove bash |
...
> 📁 Dove: `CLAUDE.md` + i documenti in `cervello/` · 📏 Quanto: mansionario di 495 righe · giro di 2092 righe · 21 manuali
...
- **5.5 I test e la CI (451 + 29 + 4)** — I test girano a ogni giro, non solo quando qualcuno se li ricorda: un test che nessuno esegue è un file, non una rete.
...
> 📁 Dove: `cervello/*.mjs` — girano prima che l'AI scriva una riga · 📏 Quanto: 391 script (85 nelle sottocartelle) · 11 sensori · 451 test + 29 prove bash
