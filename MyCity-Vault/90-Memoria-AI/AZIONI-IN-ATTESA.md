...
| 102 | 2026-08-16 11:08 | @tech | Merge PR #739 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/739 — ⚠️ AGGIORNAMENTO 2026-08-16 12:55: era verde alle 11:08, è **ricaduta rossa** (nuovi commit sul ramo rompono `cervello/test/carte-numerate.test.mjs`). NON approvare questa riga finché la card #100 non conferma di nuovo il verde: un merge ora porterebbe un test del cervello rotto su `main`. | github | in attesa (CI rossa — non mergiare) | Il codice in anteprima va online su Vercel (Pannello) dopo il merge — ma solo se la CI è verde: oggi non lo è più. | Aspetta il verde riportato dalla card #100, poi Approva: merge automatico + deploy; VPS si allinea al prossimo watch-main. |
