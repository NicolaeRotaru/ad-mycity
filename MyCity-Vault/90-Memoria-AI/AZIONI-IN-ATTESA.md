...
> 🧹 **Housekeeping 2026-07-24 18:20** — Automatico: **50 aperte · 98 chiuse in archivio**.
...
| 230 | 2026-07-23 20:43 | @tech | Merge PR #517 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/517 | github | ⚠️ MERGE FATTO ma FIX NON CONFERMATO — Nicola 24/7 ~00:00: doppione ANCORA presente dopo refresh forte | Il codice è online ma il doppione persiste per Nicola: può essere un doppione vecchio non ripulito o un bug diverso da #517. | Nicola prova in finestra incognito + "Nuova chat" x2-3: se non si duplica lì → sporcizia vecchia (non urgente); se si duplica anche in incognito → serve un secondo fix di @tech. |
...
| 234 | 2026-07-24 00:50 | @tech | Merge PR #523 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/523 | github | in attesa | Il codice in anteprima va online su Vercel (Pannello) dopo il merge. | Dopo Approva: merge automatico + deploy; VPS si allinea al prossimo watch-main. |
...
## 🛡️ Supervisione negozi & prodotti — proposte di riempimento (aggiornato 2026-07-24 18:20)
