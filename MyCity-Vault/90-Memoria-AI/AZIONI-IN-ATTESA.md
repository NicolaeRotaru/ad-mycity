...
**Cosa cambia:** il server si fa una visita di controllo due volte al giorno, alle 6:45 e alle 20:45. L'ultima riuscita è del 10 agosto alle 6:46: da allora ne ha saltate cinque. Il resto del server lavora — i suoi salvataggi arrivano su GitHub, l'ultimo stasera alle 23:42. Ma senza la visita, lassù nessuno controlla più worker, coda e sensori. E la Cabina ti mostra semafori vecchi di tre giorni: sono quelli che hai visto stasera. Da qui (sessione cloud) non posso né vedere né riavviare i servizi del server. Serve il tuo terminale.
...
### 🟡 #occhi-ambiente-cloud — Apri gli occhi delle sessioni cloud su Cabina e marketplace · ⏳ accodata 2026-08-13 00:30
...
> Ultima pulizia: 2026-08-13 12:43 · 7 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-08-13 13:06 · 7 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-08-13 14:16 · 7 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-08-13 18:07 · 7 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-08-13 18:22 · 7 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-08-13 19:20 · 7 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-08-13 20:22 · 7 card totali
...
| 20 | 2026-08-13 18:59 | @tech | Merge PR #714 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/714 | github | in attesa | Il codice in anteprima va online su Vercel (Pannello) dopo il merge. | Dopo Approva: merge automatico + deploy; VPS si allinea al prossimo watch-main. |
| 21 | 2026-08-13 21:05 | @devops-sre | Fai un push da un posto con le credenziali di GitHub: main è avanti di 4 commit e non si vedono online | 🟡 | Questa sessione chat non può parlare con GitHub (`git push origin main` fallisce sempre: nessuna credenziale). Ha 4 commit di memoria pronti sul `main` locale (recupero sensori/salute + mappa macchina) e un ramo pronto, `fix/recupero-sensori-mappa-macchina-13-8`, con un fix vero (`guardia-viva-check.mjs` — un guardiano vedeva `permessi-check.mjs` come fantasma per colpa di cartelle di lavoro lasciate in giro). Serve solo un `git push origin main` dal VPS o dal tuo terminale; poi la PR del ramo si apre da sola al prossimo giro. | manuale | in attesa | Finché non parte il push, il Pannello (che legge `main` pubblicato) resta indietro di mezza giornata di lavoro della macchina, e il fix del guardiano non entra mai in vigore. | Dopo il push confermo che il Pannello si è allineato e apro io la PR del ramo di fix. |
