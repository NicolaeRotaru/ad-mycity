...
| 230 | 2026-07-23 20:43 | @tech | Merge PR #517 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/517 | github | ✅ FATTO (verificato `git log` — merge commit `1bf07c2d`) | Il codice in anteprima va online su Vercel (Pannello) dopo il merge. | Deploy Vercel/watch-main in corso al prossimo ciclo; provare dal vivo nel browser dopo il deploy (chat nuova = 1 sola voce, click "Worker" = scheda nuova). |
