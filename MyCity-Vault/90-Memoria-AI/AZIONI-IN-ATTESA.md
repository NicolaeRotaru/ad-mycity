...
| 195 | 2026-07-19 18:40 | @tech | Merge PR #215 mycity → main (CI unit 715/715) | 🔴 | https://github.com/NicolaeRotaru/mycity/pull/215 | github | in attesa | Fix test su main (migration 107 + mock Stripe) — niente cambi visibili sul sito. **Dopo** PR fix build Render (#197). | Dopo Approva: unit CI verdi su main; deploy Render solo se build verde (#197). |
| 196 | 2026-07-19 18:40 | @tech | Merge PR #214 mycity → main (icona carrello mobile) | 🔴 | https://github.com/NicolaeRotaru/mycity/pull/214 | github | ✅ FATTO 2026-07-19 ~18:44 | Badge contatore copriva l'icona carrello — **codice su main**, sito **non** aggiornato: build Render fallito (18:56). | Dopo deploy verde (#197): ricarica telefono → icona carrello visibile. |
| 197 | 2026-07-19 18:56 | @tech | Merge PR fix build Render (`fix/render-build-orders-page` → main) | 🔴 | branch `fix/render-build-orders-page` repo mycity · commit `5497b96` · compare: https://github.com/NicolaeRotaru/mycity/compare/main...fix/render-build-orders-page · body: `consegne/tech/pr-mycity-render-build-body.md` | github | in attesa | Build Render crashato (TS pagina ordini). Push branch **OK**; apertura PR **403 rate limit** (retry 18:57, 18:59, **19:01**). Allowlist **non serve** (L-317). Limite token **worker** — Nicola può aprire PR da browser. Compare manuale o «riprova la PR» ~1h. | Deploy Render verde (~2–3 min) → poi #215 → ricarica sito da telefono. |
