...
| 206 | 2026-07-20 02:08 | @tech | Merge PR fix icona ☰ menu conv Worker (`fix/worker-menu-conv-apre` → main) | 🔴 | branch `fix/worker-menu-conv-apre` · commit `a6d96d35` · `pannello/src/app/page.tsx` | github | in attesa | Tap su ☰ in testata Worker riapre/nasconde elenco chat — sidebar #485 aveva tolto il toggle. | Dopo Approva: deploy Vercel + Ctrl+F5 → Worker → ☰ apre lista; ⚡ in basso resta Skill & comandi. |
| 207 | 2026-07-20 02:13 | @tech | Merge PR #489 Worker senza testata — «+» in barra icone basso (`fix/worker-niente-testata` → main) | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/489 · commit `ec9f36e0` · `pannello/src/app/page.tsx` | github | in attesa | Via barra «Worker / Semplice e diretto…»; + Nuova chat nella toolbar bassa con allega/video live/prompt. | Dopo Approva: deploy Vercel + Ctrl+F5 → Worker layout compatto; più spazio messaggi. |
