...
### 🟡 R3 — Ripuntare i contenuti su Pane Quotidiano (AR-006) · ✅ FIX TECNICO MERGIATO — cantiere da chiudere
**Correzione di rotta:** Casa Linda era una **demo**, non un negozio. L'**unico negozio reale** su MyCity è **Pane Quotidiano** (contratto firmato 1/7). Il cancello di allocazione è **attivo** (`cervello/allocazione-check.mjs`, gira a ogni giro). **Fatto 13/7 ~21:01 (Nicola «fai il fix»):** **12** pacchetti pesanti Garetti archiviati in `consegne/_archivio-prospect/garetti/`; sforzo attivo su PQ (**16** contenuti); `allocazione-check` → exit 0. **✅ Merge PR #349** 13/7 21:44 (`444439af`) — #119 FATTO. **Casella rossa silo resta** finché AR-006 non è chiuso in cantiere (Nicola «chiudi AR-006» = 🟢 solo memoria). Righe coda 6-8 restano congelate/rimandate (prospect). **Serve da te:** foto/scheda/consenso PQ per pacchetto pro (`PANE-QUOTIDIANO-pacchetto.md`); link CTA; primo ordine payout-test.
...
| 119 | 2026-07-13 21:01 | @tech | Merge PR #349 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/349 | github | ✅ FATTO 2026-07-13 21:44 · main `444439af` | Chiude silo allocazione: 12 asset Garetti archiviati, ripunta Pane Quotidiano, allocazione-check verde. | Casella radiografia: chiudi AR-006 in cantiere (🟢 memoria); niente più pacchetti pesanti su prospect non firmati. |
...
| 129 | 2026-07-14 00:09 | @tech | Merge PR #360 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/360 | github | in attesa | Il codice in anteprima va online su Vercel (Pannello) dopo il merge. | Dopo Approva: merge automatico + deploy; VPS si allinea al prossimo watch-main. |
| 130 | 2026-07-14 00:47 | @frontend-dev | Merge PR #362: rete sync Pannello ovunque | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/362 | github | in attesa | Segni un fix o approvi un'azione: sparisce subito ovunque (Radiografia macchina, Da approvare, Plancia, memoria) senza ricaricare la pagina. | Dopo Approva: deploy ~2 min → prova: approva un'azione legata a un difetto e guarda che si aggiorna tutto in pochi secondi. |
