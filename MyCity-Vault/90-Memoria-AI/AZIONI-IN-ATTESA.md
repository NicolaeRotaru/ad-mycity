...
> 🧹 **Housekeeping 2026-07-26 22:20** — Automatico: **51 aperte · 98 chiuse in archivio**.
...
|---|---|---|---|---|---|---|---|---|---|
| 1 | 2026-06-25 10:09 | vendite→legale | Termini commerciali **Pane Quotidiano**: **12%/0€ (eccezione contratto 1/7)**, **payout a consegna**, **nessun vincolo** | 🔴 | `consegne/legale/contratto-pane-quotidiano-bozza.md` | firma col negozio (dopo validazione legale) | ✅ **FIRMATA** Nicola 1/7 01:02 · contratto creato · firma negozio 🔴 | Pane Quotidiano accetta 12%/0€ (eccezione storica): può ricevere ordini veri e MyCity incassa commissione sul primo incasso. | Contratto firmato col negozio → onboarding payout + ordine test. |
...
| 48 | 2026-07-06 13:26 (agg. 2026-07-20 11:24) | @designer→@vendite | Stampa e posa il kit fisico del negozio (QR in cassa, vetrofania in vetrina, sacchetti) — parte quando il primo negozio sa evadere | 🔴 | Playbook Capillarità refresh 20/7: `consegne/vendite/2026-07-20-playbook-capillarita.md` (+ base 6/7). **Asset 🟢 pronti:** template neutri `creativi/output/kit-capillarita/` (6 file) + istanza PQ `creativi/output/capillarita/` (A5 cassa + vetrofania + `qr-pane-quotidiano.png`). **URL QR PQ verificato live** (HTTP 200): `/store/c0b240c0-2a86-4218-9d0f-5154f08ff929/pane-quotidiano?utm_source=qr&utm_medium=vetrina&utm_campaign=qr-pane-quotidiano`. Anteprima [[AZIONI-PRONTE]] **A35**. **Cosa firma:** ① preventivo tipografia (~€80–150, kraft 1 colore terracotta) ② posa in Pane Quotidiano. **Gate — NON stampare prima:** PQ evadibile (`#ordine-test-pq` chiuso). ⛔ **NON citare** bando «Vita in Centro 50% materiali» (inesistente, A1 ritirata 6/7) — leva alternativa: **PI26 CCIAA** 50% digitalizzazione (`#bandi-cciaa-2007`). | tipografia locale + posa a mano | ⏸ asset pronti — gated su `#ordine-test-pq` | Il primo negozio reale esce con QR in cassa + vetrofania + sacchetti brandizzati: ogni vetrina e consegna diventa cartellone MyCity. Oggi asset pronti, stampa dopo primo ordine evadibile. | Kit PQ = primo esemplare ripetibile: al 2° negozio firmato, 2 min per istanziare template neutro e stampare. |
| 49 | 2026-07-06 13:26 (agg. 2026-07-20 11:24) | @vendite→@relazioni-istituzionali | Semina i punti QR in città (partner di quartiere, bacheche) — quando ci sono almeno 3 negozi che consegnano | 🔴 | Playbook Capillarità §Punti presenza: `consegne/vendite/2026-07-20-playbook-capillarita.md`. Adesivo tondo neutro: `creativi/output/kit-capillarita/qr-adesivo-tondo.svg` + QR home `qr-mycity-home.png`. Punti: bar/edicole/associazioni (consenso partner, via @relazioni-istituzionali), bacheche Comune. **Gate AR-081:** ≥3 negozi reali **evadibili** — oggi 1 (PQ, non evadibile, 0 DELIVERED). Ogni QR con UTM per misurare conversione per punto. | posa a mano + DM/email partner | ⏸ armato — gated su ≥3 negozi evadibili | La città si riempie di QR verso MyCity a costo ≈0. Oggi non parte: 1 negozio fermo. | Con ≥3 negozi la mappa è pronta; UTM dice quali punti convertono. |
...
| 51 | 2026-07-06 14:20 (agg. 2026-07-20 12:52) | @trust-safety→@frontend-dev/@backend-dev | Fai in modo che il badge «Verificato» appaia solo ai negozi che lo meritano davvero, non a tutti | 🟡 | **Fix consegnato 20/7:** **PR #218** mycity (`f41bac1`) — `isVerifiedStore` = approvato + `stripe_charges_enabled` + `stripe_payouts_enabled` su tutti e 5 i punti UI + migrazione **108** + test **3/3**. Playbook aggiornato «fix in PR #218». **Merge 🔴 → card #213.** Difetto originale (6/7): badge decorativo su ogni negozio incluso demo Casa Linda. Spec: `consegne/trust-safety/2026-07-06-gate-codice-badge-verificato.md`. | branch → merge #213 | ✅ **CODICE PRONTO** — merge #213 pendente Nicola | Il badge smette di mentire: oggi **0 negozi** lo mostrano finché payout non è ON (PQ incluso — corretto). | Dopo merge+deploy Render: badge visibile solo a chi può incassare davvero; PQ lo guadagna con payout+1ª consegna. |
| 52 | 2026-07-06 14:45 (agg. 2026-07-20 11:30) | @relazioni-istituzionali | Manda le due mail per far entrare MyCity nell'Hub Urbano del centro: una all'Ufficio Commercio del Comune, una all'Unione Commercianti | 🔴 | Testi **aggiornati 20/7** in `consegne/relazioni-istituzionali/2026-07-20-playbook-bandi-mail-istituzioni.md` (anteprima [[AZIONI-PRONTE]] **A38**). **Mail #1** → Ufficio Commercio Comune (margherita.maini@comune.piacenza.it · 0523 492212; PEC SUAP suap@cert.comune.piacenza.it): MyCity come servizio digitale Hub + affiancamento bandi **PI26/BT26** (sportello fino **30/7**). **Mail #2** → Unione Commercianti PC (direzione@unionecommerciantipc.it · 0523 461852): aggancia bando **PI26 già comunicato** dall'Unione ai soci. ⛔ **NON citare** bando ER Regione (chiuso giugno, 350 domande) né «Vita in Centro 50% materiali» (inesistente). **Serve da Nicola:** firma reale (telefono/email/sito) + citare **Pane Quotidiano** (unico negozio reale). Mai promettere esito bando. | email (Comune) + email (Unione) — manuale | ⏸️ PARCHEGGIATA 9/7 (gate prima bottega) — **AD 20/7: sbloccabile** (PQ online; PI26 scade 30/7) | MyCity entra nel tavolo Hub come alleato istituzionale con leva bando **verificata oggi**, non bando ER morto. | Incontro 20 min → pilota 3–5 negozi soci → onboarding + kit bandi 1 pagina (`2026-07-20-kit-bandi-cciaa-negozi-1pagina.md`). |
...
| 221 | 2026-07-23 11:37 | @devops-sre | Anche il token GitHub del Pannello online (Vercel) è rotto — briefing e audit del sito non si aggiornano più | 🔴 | Nicola ha mandato screenshot del Pannello: in "Diagnosi macchina" **«Vault GitHub (Pannello)» ROSSO** (`accesso KO: GitHub 401`, legge env `OBSIDIAN_TOKEN` con fallback `GITHUB_TOKEN` — `pannello/src/lib/obsidian.ts:7`) e **«Codice marketplace (GitHub)» ROSSO** (`GitHub 401: Bad credentials`, legge `GITHUB_TOKEN` — `pannello/src/lib/github.ts:9`). È un token DIVERSO da quello del VPS (#219, quello serve a scrivere/pushare da qui): questo è il token che **Vercel** usa per leggere GitHub da fuori. Verificato ora: il repo si legge ancora in lettura semplice da questo VPS (`git fetch` ok) — il problema è solo sui due token configurati, non sul repo. **Aggiornamento 23/7 16:04:** Nicola ha rigenerato il token e fatto redeploy — screenshot delle 16:04 mostra ancora ROSSO, stesso errore "Bad credentials". Ipotesi AD confermata giusta: su Vercel c'era ANCHE `OBSIDIAN_TOKEN` col valore vecchio, priorità su `GITHUB_TOKEN` in `obsidian.ts:7`. **✅ Aggiornamento 23/7 16:27 — RISOLTO:** Nicola ha creato un unico nuovo PAT (repo `mycity`+`ad-mycity`, Contents+PR read/write) e l'ha incollato in 3 posti: `cervello/vps/.env` (VPS), `GITHUB_TOKEN` e `OBSIDIAN_TOKEN` su Vercel. Confermato da Nicola: «è tornato tutto verde». | manuale (Vercel, accesso diretto) | ✅ RISOLTO 23/7 16:27 (confermato da Nicola, tutti i sensori verdi) | Il Pannello online torna a mostrare briefing/STATO in tempo reale e gli audit del codice (`mycity`) sono di nuovo disponibili. | Chiuso insieme a #219 — entrambi i token GitHub (VPS scrittura + Vercel lettura) ora funzionano con lo stesso PAT unico. |
| 222 | 2026-07-23 16:01 | @tech | Merge PR #510 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/510 | github | ✅ FATTO 23/7 16:03 (verificato `git log` — merge commit `82dd378f`) | Il codice in anteprima va online su Vercel (Pannello) dopo il merge. | Il fallback Ollama è ora su `main`; resta solo #221 (token Vercel) a impedire che il Pannello online e gli audit del codice si aggiornino in tempo reale. |
| 223 | 2026-07-23 16:40 | @devops-sre | Il Pannello online resta ferma a un vecchio Redeploy: proponi auto-deploy filtrato a `pannello/` per non dipendere più dal click manuale | 🟡 | Nicola ha visto il Pannello "tornare indietro" dopo aver mergiato la PR #510 e ha chiesto di annullarla. **Verificato con `git diff` (commit `20ba835e`→`82dd378f`, il merge esatto della #510): tocca SOLO 5 file — 2 script Ollama nuovi + 3 file di dati interni, i cui orari vanno tutti AVANTI (12:20/13:28→14:20), mai indietro. Zero righe di pagine/componenti del Pannello.** La PR è innocente: annullarla non avrebbe risolto nulla e avrebbe buttato via lavoro buono. **Causa vera:** `pannello/vercel.json` ha `deploymentEnabled.main:false` — il Pannello NON si aggiorna da solo a ogni merge, SOLO quando qualcuno preme Redeploy a mano su Vercel; è facile cliccare un deployment vecchio nella lista invece dell'ultimo, e la UI online torna indietro pur restando il codice su `main` intatto. Proposta: filtrare l'`ignoreCommand` di Vercel per far scattare l'auto-deploy SOLO quando un commit tocca `pannello/` (i tanti commit di sola memoria restano ignorati, niente sprechi) — così nessuno deve più scegliere a mano quale deployment rimettere online. **✅ Aggiornamento 23/7 16:48 — Nicola ha approvato ("come faccio a farli fare questo deploy in automatico"): PR aperta e provata.** `pannello/vercel.json`: `deploymentEnabled.main` → `true` + `ignoreCommand` filtrato su `-- pannello/` invece di `-- .`. Testato con `git diff --quiet` su 2 casi reali: commit di sola memoria → SKIP confermato; commit che tocca `pannello/` (PR #509) → BUILD confermato. Vedi **card #224** (merge PR #511). **✅ Conferma reale 23/7 17:16 (Nicola):** «avevi ragione tu, ho fatto il deploy manuale ed è tornato tutto come prima, ed in più altre modifiche che prima non c'erano» — validazione sul campo della diagnosi: il Redeploy manuale su Vercel era davvero l'unica leva mancante (non il codice), e aveva anche altri commit accumulati in attesa dello stesso Redeploy. Chiude il cerchio verso l'auto-deploy #226 (merge PR #513) perché non ricapiti. | codice (branch + PR, come sempre) | ✅ PR pronta 23/7 16:48 — resta il merge (#224) | Il Pannello online si aggiorna da solo appena una PR di codice viene mergiata — niente più "quale deployment clicco". | Dopo il merge di #224: ogni futura PR su `pannello/` va online da sola, senza più bisogno di Redeploy manuale. |
| 224 | 2026-07-23 16:48 | @tech | ❌ Merge PR #511 ad-mycity → main — SOSTITUITA da #513 | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/511 | github | ❌ CHIUDI SENZA MERGE (Nicola aveva ragione: conflitto reale) | Nicola ha segnalato conflitti sulla #511 alle 17:00. Verificato: pulita alla creazione (16:48), ma nel frattempo `git-pr.mjs` aveva auto-committato dentro anche `consegne/finanza/2026-07-23-diagnosi-cassa-runway.md` — un file che una sentinella automatica riscrive ogni pochi minuti (RIPROVA 16:47/16:49); main l'ha aggiornato di nuovo prima del merge → conflitto reale, non un falso allarme. | Ho aperto **#513** (branch pulito, SOLO `pannello/vercel.json`, nessun file "in movimento" intorno) — quella è la PR buona da mergiare. | Chiudi la #511 su GitHub senza mergiarla (Close pull request), poi mergia la #513. |
| 225 | 2026-07-23 16:58 | @tech | Merge PR #512 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/512 | github | ✅ FATTO (verificato `git log` — merge commit `2ac3f43d`) | Il codice in anteprima va online su Vercel (Pannello) dopo il merge. | Deploy Vercel/watch-main in corso al prossimo ciclo. |
| 226 | 2026-07-23 17:03 | @tech | Merge PR #513 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/513 | github | ✅ FATTO (verificato `git log` — merge commit `27451fc9`) | Il codice in anteprima va online su Vercel (Pannello) dopo il merge. | Deploy Vercel/watch-main in corso al prossimo ciclo. |
| 227 | 2026-07-23 18:09 | @tech | Merge PR #514 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/514 | github | ✅ FATTO (verificato `git log` — merge commit `14d4c4d7`) | Il codice in anteprima va online su Vercel (Pannello) dopo il merge. | Deploy Vercel/watch-main in corso al prossimo ciclo. |
...
| 240 | 2026-07-26 11:06 | @tech | Pulisci i tag-ombrello dal contatore errori-ripetuti (esteso 3ª volta 26/7 11:06: rivisitato "mobile" come promesso) | 🟡 | `cervello/apprendimento-guardiano.mjs` riga ~52-55 (`TAG_GENERICI`): aggiungere `"marketplace"`, `"workflow"` e `"correzione-nicola"` all'elenco. Verificato a mano: "marketplace" (8/22 lezioni lette) e "workflow" (campione letto 26/7) mischiano temi scollegati sotto la stessa parola (navbar mobile, allowlist MCP, conflitti PR / tool Workflow bloccato in headless + cataloghi n8n con Nicola — solo IL PRIMO è un vero errore ricorrente, già promosso a principio in L-2026-0723-455); "correzione-nicola" è puro doppione di due tag già in whitelist ("correzione"+"nicola" separati), sfugge al filtro perché la whitelist cerca la stringa esatta. **Rivisita 26/7 11:06 (come annotato nel giro delle 06:23):** letto il cluster "mobile" per intero (8 lezioni/9 ripetizioni) — è un vero pattern, non un'etichetta-ombrello: sempre lo stesso sotto-sistema (layout responsive della chat nel Pannello, es. L-2026-0720-358 sidebar/☰ che sparisce quando si fissa per mobile). Scritto il principio in `apprendimento.json` (`_gate_26_07_1106`): ogni PR che tocca il layout della chat deve dichiarare esplicitamente "verificato su mobile (drawer/toggle) E desktop (collapse)", non un solo viewport. "plugin" e "information-architecture" restano cluster reali ma troppo eterogenei per un gate unico oggi — non aggiungerli a TAG_GENERICI (non sono etichette-ombrello), ma nemmeno pronti per un principio unico: da scomporre in tag più specifici alla prossima lezione. | manuale (3 righe di codice, stesso branch/PR di #240) | in attesa | Il pannello di controllo dell'apprendimento segnala questi tag come i difetti più ricorrenti, ma "marketplace"/"workflow"/"correzione-nicola" sono etichette-ombrello che nascondono i cluster veri; "mobile" invece è reale e ora ha un principio scritto (checklist mobile+desktop su ogni PR di layout chat) applicabile da subito senza aspettare il fix del codice. | Il prossimo report "errori che si ripetono" mostra solo pattern reali su cui vale la pena scrivere una regola, e i PR di layout chat citano la checklist mobile+desktop. |
...
## 🛡️ Supervisione negozi & prodotti — proposte di riempimento (aggiornato 2026-07-26 22:20)
...
> Ultima pulizia: 2026-07-20 12:20 · 88 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-20 14:20 · 88 card totali
...
> Ultima pulizia: 2026-07-20 22:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-21 06:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-21 08:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-21 10:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-21 11:00 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-21 12:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-21 14:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-21 16:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-21 18:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-21 20:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-21 22:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 06:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 08:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 10:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 11:01 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 11:04 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 12:16 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 12:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 12:33 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 14:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 16:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 18:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 20:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-22 22:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 06:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 08:20 · 98 card totali
...
> Ultima pulizia: 2026-07-23 11:18 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 11:32 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 11:57 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 12:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 12:47 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 12:53 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 13:07 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 13:26 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 14:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 16:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 16:35 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 16:42 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 18:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-23 20:20 · 98 card totali
...
> Ultima pulizia: 2026-07-24 08:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-24 10:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-24 11:00 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-24 12:20 · 98 card totali
...
> Ultima pulizia: 2026-07-24 18:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-24 20:20 · 98 card totali
...
> Ultima pulizia: 2026-07-25 08:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-25 10:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-25 11:00 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-25 12:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-25 14:20 · 98 card totali
...
> Ultima pulizia: 2026-07-26 08:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-26 10:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-26 11:00 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-26 12:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-26 14:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-26 16:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-26 18:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-26 20:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-26 22:20 · 98 card totali
...
**Consegna:** `consegne/relazioni-istituzionali/2026-07-20-kit-bandi-cciaa-negozi-1pagina.md` — PI26 + BT26, scadenza 30/7, disclaimer onesto (no bando ER, no Vita in Centro).

**Cosa cambia:** ogni pitch/onboarding negozio può allegare la scheda — leva «digitalizzazione rimborsata al 50%» verificata.
**Se va bene:** conversione prospect (Garetti/Peretti/Amendolara) + pilota Hub con argomento economico concreto.

- **Colore:** 🟢 (kit pronto) · condivisione al negozio = 🟡/🔴 con consenso
- **Reparto:** onboarding-negozi / relazioni-istituzionali
- **Playbook completo:** `consegne/relazioni-istituzionali/2026-07-20-playbook-bandi-mail-istituzioni.md` · anteprima [[AZIONI-PRONTE]] **A38**
...
> Ultima pulizia: 2026-07-18 16:15 · 84 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-18 16:20 · 84 card totali
...
> Ultima pulizia: 2026-07-18 17:10 · 84 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-18 18:20 · 84 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-18 20:20 · 84 card totali
...
> Ultima pulizia: 2026-07-19 06:20 · 84 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-19 08:20 · 84 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-19 10:20 · 84 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-19 11:00 · 84 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-19 11:04 · 84 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-19 11:10 · 84 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-19 11:26 · 84 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-19 12:20 · 84 card totali
...
> Ultima pulizia: 2026-07-19 20:20 · 87 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-19 22:20 · 87 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-20 06:20 · 87 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-20 08:20 · 87 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-20 10:20 · 87 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-20 11:00 · 87 card totali
...
echo '# Burn mensile infrastruttura (Nicola 20/7: Claude 200 + Vercel 30 + Supabase 50 + VPS 20 = 300)' >> /opt/mycity/ad-mycity/cervello/vps/.env
echo 'BURN_MENSILE_EUR=300' >> /opt/mycity/ad-mycity/cervello/vps/.env
```
Oppure, se Vercel sale dopo la migrazione marketplace, sostituisci `300` con il totale aggiornato.
