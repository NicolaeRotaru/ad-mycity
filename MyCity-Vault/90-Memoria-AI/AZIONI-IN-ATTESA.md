...
| 195 | 2026-07-19 18:40 | @tech | Merge PR #215 mycity → main (CI unit 715/715) | 🔴 | https://github.com/NicolaeRotaru/mycity/pull/215 | github | in attesa | Fix test su main (migration 107 + mock Stripe) — niente cambi visibili sul sito. Nicola ha già mergiato **#214** prima — mergia **#215** quando puoi per CI verde su main. | Dopo Approva: unit CI verdi su main + deploy Render (~2 min). |
| 196 | 2026-07-19 18:40 | @tech | Merge PR #214 mycity → main (icona carrello mobile) | 🔴 | https://github.com/NicolaeRotaru/mycity/pull/214 | github | ✅ FATTO 2026-07-19 ~18:44 | Badge contatore copriva l'icona carrello in navbar mobile — fix visivo. Nicola ha mergiato **prima** di #215 (ordine invertito, ok). | Deploy Render (~2–3 min) → ricarica sito da telefono e verifica icona carrello in alto a destra. |
