...
| 7 | 2026-08-03 22:45 | @tech | Fai pulizia dei rami vecchi su GitHub: sono 447 e il loro lavoro è già dentro | 🔴 | Su GitHub ci sono 447 rami oltre a `main`. Quasi tutti hanno già la loro PR mergiata: il lavoro è dentro `main`, il ramo è solo il guscio rimasto lì. Sono loro a dare l'impressione di «montagne di commit mai pubblicati» — quando una PR si chiude in squash il commit cambia impronta, quindi gli strumenti contano quel lavoro come «non pubblicato» anche quando c'è. Prima di cancellare vanno tenuti da parte i pochi che portano roba vera: **`fix/lotto-28-esenzione-che-non-conta`** (la sua PR #598 è stata chiusa senza merge e il file `cervello/test/esenzione-che-non-conta.test.mjs` su `main` non c'è) e i rami citati nella riga 8. | github | in attesa | GitHub torna leggibile: si vede a colpo d'occhio cosa è davvero in lavorazione invece di 447 nomi. E il lavoro della #598, oggi perso, torna dentro. | Dopo il tuo ok: recupero prima la #598 in una PR nuova, poi cancello solo i rami la cui PR risulta mergiata. Niente cancellazioni alla cieca. |
| 8 | 2026-08-03 22:45 | @tech | Cambia come si chiudono le PR: così com'è, quando ne mergi una uccidi le sue sorelle | 🔴 | È la causa vera del tuo terzo problema. Le PR si chiudono in «squash»: tutti i commit diventano uno solo, con un'impronta nuova. Ogni altra PR aperta sulla stessa base si ritrova quel contenuto due volte con due impronte diverse, e GitHub la marca come in conflitto: non si mergia più e finisce chiusa. È successo 12 volte sulle ultime 200 PR. La #653 lo racconta nel suo stesso testo — 401 righe e 13 prove, chiusa così; l'ho recuperata a mano, ma la #598 no. Due strade: (a) tenere lo squash e **riallineare ogni PR aperta subito dopo ogni merge** (posso farlo io in automatico), oppure (b) passare al merge normale, che non cambia le impronte e non crea il finto conflitto. | github | in attesa | Smetti di perdere lavoro già fatto e già provato. Oggi ogni merge mette a rischio le PR aperte in quel momento. | Dopo il tuo ok: se scegli (a) collego il riallineamento automatico dopo ogni merge; se scegli (b) cambi l'impostazione su GitHub e io adeguo lo strumento che apre le PR. |
