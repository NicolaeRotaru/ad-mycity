...
| 19 | 2026-07-02 07:35 | tech | **Deploy fix ruoli acquisto** — admin bloccato, seller solo via «Vai al marketplace» (modalità cookie) | 🔴 | `consegne/tech/2026-07-02-ruoli-acquisto-admin-seller.md` · branch `fix/ruoli-acquisto-admin-seller-2026-07-02` su `NicolaeRotaru/mycity` | Render (marketplace) | in attesa | Gli account assistenza non possono più creare carrelli/ordini test; i venditori non finiscono sul catalogo per errore — solo se cliccano il pulsante dedicato. | CRM pulito (1 solo carrello buyer reale); meno confusione ruoli in onboarding 6/7. |
