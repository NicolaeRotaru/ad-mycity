...
| 119 | 2026-07-13 21:01 | @tech | Merge PR #349 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/349 | github | ✅ conflitto risolto AD 21:43 · head `319206ee` · card verde | Chiude silo allocazione: 12 asset Garetti archiviati, ripunta Pane Quotidiano, allocazione-check verde. | Dopo Approva: casella rossa silo sparisce; niente più pacchetti pesanti su prospect non firmati. |
...
| 123 | 2026-07-13 21:47 | @frontend-dev | Merge PR #354: auto-rimuovi card merge dopo merge GitHub | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/354 | github | in attesa | Dopo che mergi una PR su GitHub, la card «Merge PR #N» sparisce da sola da Da approvare — niente più caselle fantasma. | Approva → deploy ~2 min → mergia una PR e verifica che la card sparisce entro ~15 secondi. |
| 124 | 2026-07-13 21:48 | @tech | Merge PR #355 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/355 | github | in attesa | Il codice in anteprima va online su Vercel (Pannello) dopo il merge. | Dopo Approva: merge automatico + deploy; VPS si allinea al prossimo watch-main. |
| 125 | 2026-07-13 22:28 | @tech | Merge PR #356 ad-mycity → main | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/356 | github | in attesa | Il codice in anteprima va online su Vercel (Pannello) dopo il merge. | Dopo Approva: merge automatico + deploy; VPS si allinea al prossimo watch-main. |
...
## 🛡️ Supervisione negozi & prodotti — proposte di riempimento (aggiornato 2026-07-13 22:20)
