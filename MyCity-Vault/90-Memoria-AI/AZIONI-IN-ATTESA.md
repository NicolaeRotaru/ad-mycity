...
| 122 | 2026-07-13 21:13 | @tech | Mergia PR #352: chip Grillami e Codice minimo nel menù ⚡ | 🔴 | https://github.com/NicolaeRotaru/ad-mycity/pull/352 | github | ⚠️ conflitto 21:16 — vedi sotto | Nell'icona fulmine accanto a Invia compaiono «Grillami» e «Codice minimo» in cima alle skill rapide. | Resolve conflicts: body → testo Grillami; memoria → Accept main → Approva → deploy ~2 min → ⚡. |
