...
## Coda
| # | Data e ora | Reparto | Azione (pronta) | Colore | Contenuto | Canale | Stato |
|---|---|---|---|---|---|---|---|
| 1 | 2026-06-25 10:09 | vendite | Termini commerciali a Garetti: commissione **12%**, **0€ costi fissi**, **payout a consegna confermata**, **nessun vincolo** | 🔴 | consegne/vendite/pitch-garetti.md (Parte C) | di persona al go-live (condizioni 1 pagina via @legale) | in attesa |
| 2 | 2026-06-25 10:09 | finanza | Modalità payout-test: **1€ reale** (da stornare dopo) **o** ambiente test Stripe | 🔴 | consegne/finanza/payout-faro.md | onboarding min 17-20 | in attesa |
...
| 6 | 2026-06-27 00:39 | @content-social | Post "Con 38°C non esci, te la portiamo noi" — cavalca l'ondata di caldo. **Bozza ora PRONTA** (creata 28/6 02:05); resta da pubblicare sui canali reali. Cosa cambia: post tempestivo nel giorno di picco (38-39°C) che acquisisce iscritti a costo ≈0. Se va bene: collego il link lista (UTM caldo_38) e pubblico. | 🔴 | consegne/content/POST-caldo-38.md | IG/FB + gruppi quartiere | in attesa |
...
| 8 | 2026-06-28 01:27 | @marketing | **Presidio Sant'Antonino (3-4/7)**: attivare turni + stampa materiali (QR `santantonino_2026` + volantino A6 "te lo portiamo a casa"). Cosa cambia: la finestra fisica più grande del mese (centro pieno per la festa del patrono, culmine fiera 4/7) diventa lead-vendite + iscritti a costo ≈0. Se va bene: agganciamo i negozianti aperti e raccogliamo iscritti reali nella settimana clou. | 🟡 | consegne/marketing/2026-07-04-piano-santantonino.md | manuale (presenza fisica) + stampa 🔴 | in attesa |
...
<!-- I senior aggiungono righe qui sotto. Metti SEMPRE data E ora (AAAA-MM-GG HH:MM). Esempio:
| 1 | 2026-06-25 14:30 | crm | Email benvenuto ai primi 10 iscritti | 🟡 | consegne/crm/benvenuto.md | email (Resend) | in attesa |
-->
