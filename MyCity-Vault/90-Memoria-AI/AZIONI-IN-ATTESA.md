...
> 🧹 **Housekeeping 2026-08-16 10:23** — Automatico: **70 aperte · 8 chiuse in archivio**.
>
...
## 🛡️ Supervisione negozi & prodotti — proposte di riempimento (aggiornato 2026-08-16 10:23)
...
> Ultima pulizia: 2026-08-16 10:23 · 8 card totali
...
| 100 | 2026-08-16 10:26 | @tech | Due richieste di unione restano rosse da giorni: ho messo due riparazioni al lavoro adesso | 🟡 | `ci-stato.mjs` (rilanciato dal vivo alle 10:25): PR #739 e PR #735 hanno entrambe 2 controlli falliti su 2, colpa dei rispettivi rami — non di main. In questo stesso giro ho fatto partire due lavori separati per ripararle sul loro ramo (senza toccare `main`): uno sul test "la sola lettura che scrive" (#739), uno sul gate delle lezioni (#735). Il risultato arriverà dopo la chiusura di questo giro: lo riporto al passaggio successivo. | github | in attesa | Finché restano rosse, non puoi mergiarle in sicurezza e il tetto delle PR aperte-e-rosse resta a 2. | Appena i due lavori confermano il verde, apro/aggiorno le PR con il fix e te lo segnalo qui pronto da firmare. |
