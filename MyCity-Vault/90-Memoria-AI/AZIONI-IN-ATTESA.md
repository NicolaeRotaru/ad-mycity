...
| 195 | 2026-07-19 18:40 | @tech | Merge PR #215 mycity → main (CI unit 715/715) | 🔴 | https://github.com/NicolaeRotaru/mycity/pull/215 | github | in attesa | Fix test su main (migration 107 + mock Stripe) — niente cambi visibili sul sito. **Mergia questa prima di #214.** | Dopo Approva: unit CI verdi su main + deploy Render (~2 min). |
| 196 | 2026-07-19 18:40 | @tech | Merge PR #214 mycity → main (icona carrello mobile) | 🔴 | https://github.com/NicolaeRotaru/mycity/pull/214 | github | in attesa | Badge contatore copriva l'icona carrello in navbar mobile — fix visivo. **Dopo #215.** | Dopo Approva: deploy Render (~2–3 min) → ricarica sito da telefono. |
