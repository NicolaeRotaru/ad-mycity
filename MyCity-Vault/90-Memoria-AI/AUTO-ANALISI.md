...
- Stripe non collegato → runway/cassa `sconosciuto` (noto, non un guasto).
...
- ❓ Chi/perché ha annullato l'ordine #16 il 3/7 15:38 (domanda storica aperta).

## Salute
Piattaforma tecnicamente al sicuro (bloccanti umani a 0). Loop business **aperto** (North Star 0, 0 transazioni reali) — è il vero collo di bottiglia, si sblocca dal 13/7 con il 1° ordine reale su PQ e le 6 botteghe food. Vincolo allocazione HARD **rispettato** (nessun asset pesante).
