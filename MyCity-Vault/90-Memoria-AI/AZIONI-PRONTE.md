...
pre-condizioni: (1) link marketplace in bio/1° commento UTM `no-fornelli-1608` · (2) timing 12:00–13:30 (pranzo) o 17:00–19:00 (cena) · (3) foto reale = ok titolare se boost. Coda canonica = **#108** in [[AZIONI-IN-ATTESA]] (rinumerata da #106 il 16/8 16:35: quel numero era già preso da un'altra riga).
stato: IN ATTESA DI FIRMA NICOLA.
