---
tipo: storico
fonte: AZIONI-IN-ATTESA.md
potato: 2026-07-28 18:12
---

> 📦 Storico di **AZIONI-IN-ATTESA.md** (2026-07). Spostato qui da `cervello/pota-memoria.mjs` perché il file vivo
...
| 247 | 2026-07-28 16:45 | @security | Togli al cervello il permesso di scriversi la firma da solo | 🔴 | Supabase (progetto MEMORIA) → tabella `impostazioni` · dettaglio: `node cervello/firma-check.mjs` | supabase (configurazione) | in attesa | Oggi la firma con cui approvi un'azione vive in una riga che il cervello può scrivere con la stessa chiave con cui la legge: un guardiano se ne accorgerebbe, ma niente glielo impedisce. Serve una chiave (o una regola RLS) che vieti al ruolo del cervello di scrivere le chiavi `azione:*:firma`. Da lì in poi chi propone e chi firma sono separati davvero, non per buona educazione. | Chiude AR-119, l'ultimo punto in cui l'esecutore potrebbe autorizzarsi da solo. Finché non c'è, il confine resta sorvegliato ma non chiuso. |
...
> Ultima pulizia: 2026-07-27 06:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-27 08:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-27 10:20 · 98 card totali
...
> Ultima pulizia: 2026-07-27 18:20 · 98 card totali

---

## 🗄️ Archivio — card chiuse

> Ultima pulizia: 2026-07-27 20:20 · 98 card totali
