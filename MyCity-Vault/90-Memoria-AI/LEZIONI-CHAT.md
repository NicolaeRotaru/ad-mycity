...
- [2026-07-13] Tab Piani tronca l'inizio: `codaTesto(...,12000)` in `/api/memoria/piani` mostra solo la coda del file — i piani (12–26 KB) partono a metà frase; attività/decisioni sì, piani no: file intero. Fix PR #322, merge 🔴 #95.
