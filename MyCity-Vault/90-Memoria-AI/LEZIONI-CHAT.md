...
- [2026-07-11] Per lavori "risolvi tutti i problemi X": inizia SUBITO a scrivere i fix (🟢 Write/Edit) senza chiedere "come vuoi procedere?". La scrittura dei file NON richiede branch attivo né approvazione. Solo il branch creation (git checkout -b) e il commit/push finale sono 🟡. Accoda quelli alla fine — non bloccarti all'inizio.
