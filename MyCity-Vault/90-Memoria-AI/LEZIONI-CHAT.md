...
- [2026-07-13] Plugin worker token: Nicola ha scelto grilling + ponytail + caveman (repo GitHub curati) — caveman OFF in chat con lui (tono telegrafico vs contratto «chiaro, non tecnico»); ponytail solo codice; grilling su decisioni/PR; PR manifest+sync 🟡 dopo sua conferma esplicita.
...
- [2026-07-13] Apprendimento si aggiorna post-chat (metabolizzazione worker ≥160 char), Miglioramento leggero ogni ~10 min, benchmark pesante venerdì/giro AI — NON dire «solo giro AI» per apprendimento. UI «03/07» = bug legge solo `data`; fix in PR #315.
