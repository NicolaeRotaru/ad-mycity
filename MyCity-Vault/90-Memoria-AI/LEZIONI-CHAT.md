...
- [2026-07-13] Pallino riaccende dopo ~5s — apri chat → pallino via → poll (~5s) timestamp lavoro > lettura → pallino torna; fix **#336** (max orario chat+lavoro + riallineamento poll, `ee9d3f9b`), **#334 chiudi**; #328/#332 già su main = sync; merge 🔴 #108; fix incompleto = push sulla STESSA PR, non #334→#336.
