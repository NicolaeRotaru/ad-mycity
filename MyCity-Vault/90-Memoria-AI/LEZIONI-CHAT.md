...
- [2026-07-13] PR Pannello con conflitti: quasi sempre file memoria worker nel branch, non il fix — ripulire a solo file Pannello target + simulare merge su main HEAD prima di «pronta» (pattern #315/#316/#318).
