...
> Aggiornato: **2026-07-02 08:36** · Fonte: @intelligence + REST live (407 lead `merchants_leads`).
...
|---|------------------|--------|------------|--------------|
| 1 | **Panetteria bio artigiana** (centro) | Pane Quotidiano = unico reale; #16 oggi pranzo | Alto — 1ª transazione | **1 negozio LIVE**, 0 delivered |
...
## Blocco attuale
- **407 lead** — outreach **post-1ª-transazione** (#16 oggi pranzo).
- Stallo **190,1h** (+22,1h oltre 168h).
- **#19** fix ruoli: branch pronto su clone marketplace — merge 🔴 in attesa.
- Sprint 1 **LIVE** — resta **SQL 107** prima batch 6/7 sicuro.
- Kit bando #12: FESR Commercio **chiuso 23/6** — pivot bandi.

## Mossa collegata (2/7 08:36)
