...
| **Dom 28/6** | Mercatino creativo "Sotto le stelle" | San Pietro in Cerro | Fuori area servita |
| **19/6 → 17/7** | Grande manifestazione centro: **~200 eventi, ~300 negozi aperti**, 5 date | Centro Piacenza | 🔥 **Centro vivo per settimane** → presidio fisico + ambassador negozi |

## 🎯 Consigli operativi (questo giro)
1. **Oggi domina il meteo, non gli eventi:** la priorità è la **catena del freddo** sulla prima consegna,
   non il presidio eventi. Eventi = leva di awareness secondaria.
2. Il **centro resta animato fino a metà luglio** (300 negozi aperti): finestra lunga per il
   **presidio fisico/QR** e per agganciare i negozianti aperti (lead vendite). → @vendite, @marketing.
