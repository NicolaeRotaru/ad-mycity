...
## Stato attuale
- **In attesa del primo monitoraggio.** Fase 0: MyCity è agli inizi (1 negozio, pochi clienti) →
  poche menzioni esterne attese. Il valore di questa scheda cresce coi primi ordini e la prima PR.

## Cosa terrà d'occhio quando è acceso
- **Menzioni di "MyCity Piacenza"** su Libertà/Telelibertà/IlPiacenza/PiacenzaSera e social.
- **Recensioni Google** dei negozi a bordo (a partire da Garetti) e della piattaforma.
- **Gruppi Facebook di quartiere** ("Sei di Piacenza se…", quartieri) — passaparola e dubbi.
- **Sentiment** (positivo/neutro/negativo) e le **lamentele ricorrenti** da sistemare subito.
