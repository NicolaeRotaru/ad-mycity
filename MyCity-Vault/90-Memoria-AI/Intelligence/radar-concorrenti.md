...
> |---|---|---|
> | **Glovo** | Fetch diretto riuscito (raro, di solito 403): categorie confermate identiche al 24/8 — Cibo, Spesa, Negozi, Parafarmacia e Bellezza, Spedizioni. Nessuna nuova categoria, nessuna promo Piacenza specifica | [glovoapp.com/it/it/piacenza](https://glovoapp.com/it/it/piacenza/) (WebFetch diretto, 1/9) |
> | **Conad — Spesa online** | Copertura invariata: 3 Superstore Piacenza (via Atleti Azzurri d'Italia, via Grazia Deledda, via Don G. Morisi) + Sapori & Dintorni + Podenzano/Rivergaro/Castell'Arquato/San Giorgio Piacentino. Due modelli "Spesa a Casa"/"Ordina e Ritira" confermati, nessuna soglia/promo nuova trovata | [spesaonline.conad.it/aree-coperte-dal-servizio/piacenza](https://spesaonline.conad.it/aree-coperte-dal-servizio/piacenza) (WebFetch, 1/9) |
> | **Cortilia** | Homepage generica invariata, nessuna menzione di Piacenza nel contenuto, nessuna novità di prezzo/servizio | [cortilia.it](https://www.cortilia.it/) (WebFetch, 1/9) |
