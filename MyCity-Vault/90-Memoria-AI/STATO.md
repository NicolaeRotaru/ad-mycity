---
tipo: stato
aggiornato: 2026-07-01 10:45
fonte: AD digitale (7 numeri = live REST 1/7 08:17 · chat Nicola 10:45 flusso merge permanente + istruzioni PAT · 10:36 ok merge bottoni A/B → main c50148d · 10:22 merge-on-approval · Supabase clmpyfvpvfjgeviworth · Sprint 1 ok 07:30 · push PR 403 07:41)
---
...
1. **Chat 1/7 10:36** — Nicola «**ok merge bottoni A/B**» → push **`main`** `c50148d` (3 file Pannello) · Vercel redeploy · **click A o B ordine ancora 🔴**
2. **Chat 1/7 10:22** — Nicola chiede architettura `pannello/` + **merge automatico con permesso** · spiegati 3 tubi git/deploy · **#15 GITHUB_MERGE_TOKEN** · pattern «ok merge …» **testato con successo** su bottoni A/B
3. **Chat 1/7 10:13** — Nicola ok fix UX: bottoni **A/B** al posto di Approva/Ignora sulla proposta ordine zombie · codice implementato · deploy completato 10:36
4. **Chat 1/7 09:43** — Nicola «ok timer ritmo» → unit + script in repo · AR-005 chiuso · **1 comando root** sul VPS per accendere i timer.
5. **Chat 1/7 09:39** — Nicola rettifica casella cadenza-esecuzione: tolto mycity-live · AR-002 → copertura-cieca · L-2026-0701-27.
6. **Giro 1/7 08:17** — KPI live REST stallo 165,8h (+2h), 168h ~2,2h. Escalation v5 🟢. Briefing + auto-coscienza.
7. **Chat 1/7 07:41** — Nicola «crea la PR» → push+API GitHub **403** (PAT senza write su `mycity`). Patch salvata · **#14** token in coda.
8. **Chat 1/7 07:30** — Nicola «**ok Sprint 1**» → fix 4 bloccanti + extra urgenti su branch marketplace (no deploy).
...
- [x] ~~Deploy bottoni A/B Pannello~~ — Nicola «ok merge bottoni A/B» 10:36 · `main` `c50148d`
