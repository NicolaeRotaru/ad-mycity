...
4. **Metabolizzazione 1/7 06:29** — lezione L-0701-22 guardrail universale + quaderni builder/security.
5. **Metabolizzazione 1/7 01:59** — guardrail 🔴 pre-mortem → `guardrail-semaforo.mjs`.
6. **Chat 1/7 01:02** — Nicola firma foglio-firma: contratto PQ 12% · payout 03/7 · sandbox.
