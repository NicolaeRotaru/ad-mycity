# 🚲 Operazioni & Logistica (vista COO)

> Filosofia: non sei food-delivery on-demand, sei **micro-logistica urbana con batching giornaliero**. Ogni decisione massimizza gli **ordini-per-giro**. Collega a [[Decisioni Aperte]] · [[Finanza & Unit Economics]] · [[Gestione Rider e Pool Fattorini]].
...
- 🔴 **Il modello "negozio consegna" è incompatibile** col carrello multi-bottega (5 negozi non consegnano alla stessa porta). → risolve [[Decisioni Aperte|Decisione 1]].
...
3 zone (freddo 0-4°C / congelato / ambiente), **packaging passivo a PCM** (gel pack), separazione caldo/freddo, **checklist temperatura al ritiro**. Transito <2h grazie al batching rende il passivo sufficiente in v1. Vedi obblighi HACCP in [[Rischi & Compliance]].
