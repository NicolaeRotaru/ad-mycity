...
- **Oggi 19/7:** caldo 34°C + afa (3BMeteo 14:20) → freschi PQ solo mattina.
- **Ordine test Nicola su PQ** = unica mossa operativa prioritaria (North Star 0→1).
- **21/7 pioggia** → finestra delivery domestica; push clienti solo dopo ordine test.
