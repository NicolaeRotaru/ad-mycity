# 🔀 Decisioni Aperte (trade-off & domande)
...
- 👉 *Raccomandazione AGGIORNATA (vedi [[Operazioni & Logistica]]):* con il **carrello multi-negozio l'Opzione A è incompatibile** (5 botteghe non consegnano alla stessa porta). Va scelta **B = rider proprio su cargo-bike elettrica** (accesso ZTL 8-19), con **batching giornaliero D+1** e micro-hub di consolidamento. All'inizio il rider è il fondatore. Decide molto di [[Area - Consegna]].
...
- 👉 *Raccomandazione (dati):* commissione al negozio **10-15%** (vs ~30% di Glovo, odiato dai negozi) + **fee consegna al cliente ~€2,50** (benchmark Daje) o €4-5 (Everli). È la leva di vendita verso i negozi. ⚠️ Verificare che il margine copra il costo consegna **solo col batching** (vedi [[Mercato, Numeri & Contesto|§4]] e [[Casi Studio]]).
...
- 👉 *Raccomandazione (vedi [[Brand & Posizionamento]]):* valutare **`Bottega Piacenza`** + firma `la Primogenita`, oppure tenere MyCity con architettura endorser ("MyCity · le botteghe del centro di Piacenza"). Decisione da prendere prima di investire in identità visiva/stampa.
