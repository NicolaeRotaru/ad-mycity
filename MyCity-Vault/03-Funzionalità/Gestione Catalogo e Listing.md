...
Editor prodotto per il negozio: titolo, descrizione, foto multiple, prezzo, categoria, disponibilità, eventuali varianti (taglia/peso). Modello consigliato all'inizio: **listing liberi per negozio** (stile eBay/Glovo), perché i negozi locali sono eterogenei (alimentari, ferramenta, fiori…). Decisione in [[05-Decisioni-Aperte]].
