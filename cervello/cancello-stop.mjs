...
export function verdetto({
  ...
  const righe = [];
  // ⑦ IL COLLAUDO DEL LAVORO FINITO (AR-518, Nicola 4/8: «ricontrolla il lavoro fatto, analizzalo
...
async function main() {
  ...
  // ⑦ Il collaudo del lavoro finito (AR-518): SOLO dentro l'hook Stop, perché il ricontrollo lo fa
