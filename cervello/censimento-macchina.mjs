...
export const DESCRIZIONI = {
  ...
  skill: {
    ...
    // ── Skill di marketing/prodotto/copy importate dal pacchetto marketing (uso dei senior via Skill) ──
    "ab-testing": "Progetta ed esegue A/B test ed esperimenti di crescita: ipotesi, varianti, significatività, quanto farli girare.",
    "ad-creative": "Genera e itera creatività per ads a pagamento — titoli, testi, varianti — su qualunque piattaforma.",
    ads: "Strategia di campagne a pagamento (Google/Meta/LinkedIn): targeting, budget, ROAS/CPA, quando spegnere un'ads.",
    "ai-seo": "Ottimizza i contenuti per i motori di risposta AI (ChatGPT, Perplexity, AI Overviews): farsi citare, non solo farsi cliccare.",
    analytics: "Imposta o audita tracking e misurazione: GA4, eventi, UTM, tag manager, «i miei eventi funzionano?».",
    aso: "Audit e ottimizzazione della scheda App Store/Google Play: visibilità, keyword, conversione dell'annuncio app.",
    "churn-prevention": "Riduce l'abbandono: flussi di cancellazione, offerte di salvataggio, recupero pagamenti falliti, win-back.",
    "co-marketing": "Trova partner di co-marketing e pianifica campagne congiunte tra due aziende non concorrenti.",
    "code-simplifier": "Semplifica e rifinisce codice per chiarezza e manutenibilità, senza cambiarne il comportamento.",
    "codebase-design": "Vocabolario condiviso per progettare moduli «profondi»: interfacce pulite, dove mettere un confine nel codice.",
    "codebase-search": "Esplora repository remote con il motore di ricerca di Tabnine: architetture, impatto di una PR, uso reale di un'API esterna.",
    "cold-email": "Scrive email di outreach B2B a freddo e le sequenze di follow-up che ottengono risposte.",
    "community-marketing": "Costruisce e sfrutta community online (Discord/Slack/forum) per crescita e passaparola.",
    "competitor-profiling": "Profila i concorrenti a partire dai loro URL: ricerca strutturata, non impressioni.",
    competitors: "Crea pagine di confronto/alternative per SEO e vendite («X vs Y», «alternativa a X»).",
    "content-strategy": "Pianifica COSA scrivere: pilastri di contenuto, cluster di argomenti, calendario editoriale.",
    "copy-editing": "Rilegge e migliora testi di marketing già scritti: più chiari, più snelli, aggiornati.",
    copywriting: "Scrive o riscrive testi di marketing per pagine web: home, landing, prezzi, prodotto.",
    cro: "Ottimizza la conversione di una pagina o di un modulo: funnel, frizioni, perché non converte.",
    "customer-research": "Conduce e sintetizza ricerca sui clienti: interviste, survey, recensioni, forum — cosa dicono davvero.",
    "diagnosing-bugs": "Percorso di diagnosi per bug difficili e regressioni di prestazioni: causa prima, non sintomo.",
    "differential-review": "Revisione di sicurezza differenziale su PR/commit/diff: raggio d'impatto, copertura test, regressioni.",
    "directory-submissions": "Pianifica la sottomissione del prodotto a directory (Product Hunt, G2, AI directories) per backlink e scoperta.",
    docx: "Crea, legge o modifica documenti Word (.docx/.dotx): report, memo, template con formattazione.",
    emails: "Progetta sequenze email automatiche: onboarding, nurture, win-back, cadenza del ciclo di vita.",
    firecrawl: "Cerca e scarica contenuto dal web via CLI Firecrawl: ricerca, scraping, pagine con login/click.",
    "free-tools": "Valuta o progetta uno strumento gratuito da regalare per generare lead (calcolatore, grader).",
    grilling: "Mette sotto torchio un piano o una decisione con domande scomode, per stress-testarla prima di eseguirla.",
    handoff: "Comprime la conversazione corrente in un documento di passaggio perché un altro agente continui il lavoro.",
    image: "Genera o ottimizza immagini di marketing: hero, grafiche social, mockup prodotto, OG image.",
    launch: "Pianifica il lancio di un prodotto o di una funzione: checklist, Product Hunt, waitlist, go-to-market.",
    "lead-magnets": "Progetta un contenuto scaricabile per catturare email: ebook, checklist, template.",
    "marketing-council": "Simula un consiglio di grandi esperti di marketing (Godin, Ogilvy, Hormozi…) su una domanda specifica.",
    "marketing-ideas": "Banca di idee di marketing per uno SaaS quando manca l'ispirazione su cosa provare.",
    "marketing-loops": "Imposta un flusso di marketing ricorrente e automatico (settimanale, su trigger) eseguito da un agente.",
    "marketing-plan": "Genera un piano di marketing completo (AARRR) su misura di stadio, budget e team di un'azienda.",
    "marketing-psychology": "Applica principi di psicologia e scienza comportamentale alle scelte di marketing.",
    offers: "Costruisce l'offerta dietro il prezzo: bonus, garanzie, urgenza, come si presenta il valore.",
    onboarding: "Progetta il primo utilizzo del prodotto: cosa vede e fa un utente nuovo prima di restare.",
    paywalls: "Progetta dove e come mostrare un paywall in-app per convertire da gratis a pagante.",
    pdf: "Crea, legge o modifica documenti PDF.",
    ponytail: "Task che toccano solo codice: li scala al minimo indispensabile, senza aggiungere cerimonia.",
    popups: "Progetta popup e modali (exit-intent, promozioni) senza infastidire l'utente.",
    pricing: "Progetta pagine e strategie di prezzo: piani, ancoraggio, cosa mostrare per far scegliere il piano giusto.",
    "product-marketing": "Posizionamento e ICP: chi è il cliente, perché sceglie noi, messaggio differenziante.",
    "programmatic-seo": "Genera pagine SEO su scala da un set di dati/template (es. una pagina per città/categoria).",
    prospecting: "Trova e qualifica potenziali clienti/lead prima del contatto di vendita.",
    "public-relations": "Comunicati stampa, contatti giornalisti, angoli notiziabili per ottenere copertura editoriale.",
    "react-best-practices": "Linee guida React: pattern corretti, cosa evitare, come strutturare i componenti.",
    referrals: "Progetta un programma di referral: chi invita chi, quale ricompensa, come si misura.",
    revops: "Revenue operations: funnel end-to-end marketing→vendite→success, definizioni condivise dei KPI commerciali.",
    "sales-enablement": "Materiali per le vendite oltre le email: battle card, one-pager, obiezioni e risposte.",
    schema: "Implementa dati strutturati (schema.org) per far leggere meglio le pagine ai motori di ricerca.",
    "seo-audit": "Audit SEO tecnico e on-page: cosa blocca il posizionamento organico di un sito.",
    signup: "Ottimizza il flusso di registrazione: frizioni, campi, conversione da visitatore a account.",
    "site-architecture": "Progetta la struttura del sito: gerarchia di pagine, URL, navigazione per SEO e usabilità.",
    sms: "Progetta campagne e sequenze via SMS: quando l'SMS batte l'email, come non essere invasivi.",
    social: "Calendario e contenuti social: post, caption, script reel per i canali del marchio.",
    supabase: "Guida sull'uso di Supabase: schema, RLS, query, best practice del progetto.",
    "supabase-postgres-best-practices": "Best practice Postgres su Supabase: indici, query, migrazioni sicure.",
    superpowers: "Raccolta di capacità/estensioni generiche richiamabili dagli agenti.",
    "systematic-debugging": "Metodo sistematico da seguire davanti a un bug, un test rotto o un comportamento inatteso, prima di proporre un fix.",
    tdd: "Guida allo sviluppo guidato dai test: scrivere il test prima del codice.",
    video: "Produzione video di marketing: script, montaggio, sottotitoli, formati per i social.",
    "web-design-guidelines": "Linee guida di design web: leggibilità, gerarchia visiva, coerenza dell'interfaccia.",
    "webapp-testing": "Testa una web app end-to-end guidando un browser vero, non solo il codice.",
    xlsx: "Crea, legge o modifica fogli di calcolo Excel (.xlsx).",
  },
