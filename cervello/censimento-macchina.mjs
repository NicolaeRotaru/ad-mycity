...
export const DESCRIZIONI = {
  ...
  skill: {
    ...
    // ── Pacchetto marketing/ingegneria (arrivato 11-13/8) ─────────────────
    "ab-testing": "Pianifica e disegna A/B test ed esperimenti di crescita.",
    "ad-creative": "Genera e itera creatività per ads (titoli, testi, varianti) su ogni piattaforma.",
    ads: "Gestisce campagne a pagamento (Google/Meta/LinkedIn/X) — targeting, budget, ottimizzazione.",
    "ai-seo": "Ottimizza i contenuti per i motori di ricerca AI (AEO/GEO) e le citazioni nei modelli.",
    analytics: "Imposta e verifica il tracciamento e la misurazione (GA4, eventi, UTM, GTM).",
    aso: "Audit e ottimizzazione delle schede App Store/Google Play.",
    "churn-prevention": "Riduce l'abbandono clienti — flussi di cancellazione, offerte di salvataggio, recupero pagamenti falliti.",
    "co-marketing": "Trova partner e pianifica campagne congiunte di co-marketing.",
    "code-simplifier": "Semplifica e rifinisce codice per chiarezza e manutenibilità.",
    "codebase-design": "Vocabolario condiviso per progettare moduli \"profondi\" e interfacce pulite.",
    "codebase-search": "Esplora repository remoti con il motore di ricerca di codice Tabnine.",
    "cold-email": "Scrive email a freddo B2B e sequenze di follow-up che ottengono risposte.",
    "community-marketing": "Costruisce e sfrutta community online per la crescita del prodotto.",
    "competitor-profiling": "Profila e analizza i concorrenti a partire dai loro URL.",
    competitors: "Crea pagine di confronto/alternative per SEO e supporto vendite.",
    "content-strategy": "Pianifica la strategia dei contenuti — cosa scrivere e perché.",
    "copy-editing": "Rivede e migliora testi di marketing già scritti.",
    copywriting: "Scrive o riscrive testi di marketing per pagine del sito.",
    cro: "Ottimizza il tasso di conversione di pagine e form.",
    "customer-research": "Conduce e sintetizza ricerca sui clienti (interviste, recensioni, survey).",
    "diagnosing-bugs": "Guida la diagnosi di bug difficili e regressioni di performance.",
    "differential-review": "Revisione di sicurezza differenziale su modifiche di codice (PR/commit/diff).",
    "directory-submissions": "Pianifica la sottomissione del prodotto a directory (backlink, scoperta).",
    docx: "Crea, legge e modifica documenti Word (.docx/.dotx).",
    emails: "Crea e ottimizza sequenze email automatiche di ciclo di vita.",
    firecrawl: "Cerca e naviga il web (ricerca, scraping, interazione con pagine).",
    "free-tools": "Pianifica e valuta strumenti gratuiti per marketing (lead gen, SEO, brand).",
    grilling: "Mette sotto torchio un piano o una decisione per metterla alla prova.",
    handoff: "Passaggio di consegne strutturato tra sessioni o agenti.",
    image: "Genera, modifica e ottimizza immagini per marketing.",
    launch: "Pianifica il lancio di un prodotto o di una funzione.",
    "lead-magnets": "Crea e ottimizza contenuti-esca per la raccolta contatti.",
    "marketing-council": "Consulto simulato con più esperti di marketing leggendari su una domanda.",
    "marketing-ideas": "Genera idee e ispirazione di marketing per prodotti software.",
    "marketing-loops": "Imposta flussi di marketing ricorrenti e automatici.",
    "marketing-plan": "Costruisce un piano di marketing completo (AARRR) per cliente o prodotto.",
    "marketing-psychology": "Applica principi psicologici e modelli mentali al marketing.",
    offers: "Costruisce l'offerta (bonus, garanzie, urgenza) attorno a un prodotto.",
    onboarding: "Progetta l'onboarding in-app dei nuovi utenti.",
    paywalls: "Progetta paywall e upgrade in-app.",
    pdf: "Crea, legge e modifica documenti PDF.",
    ponytail: "Riduce al minimo indispensabile i task che toccano codice.",
    popups: "Progetta popup e modali di conversione.",
    pricing: "Definisce prezzi e piani tariffari.",
    "product-marketing": "Posizionamento, ICP e messaging di prodotto.",
    "programmatic-seo": "Crea pagine SEO programmatiche su larga scala.",
    prospecting: "Trova e qualifica potenziali clienti.",
    "public-relations": "Gestisce comunicati stampa e relazioni coi media.",
    "react-best-practices": "Applica le buone pratiche di sviluppo React.",
    referrals: "Progetta programmi di referral clienti.",
    revops: "Allinea le revenue operations tra marketing, vendite e success.",
    "sales-enablement": "Prepara materiali di supporto vendita.",
    schema: "Implementa dati strutturati (schema.org) sulle pagine.",
    "seo-audit": "Esegue audit tecnico e on-page SEO.",
    signup: "Ottimizza i flussi di registrazione.",
    "site-architecture": "Progetta l'architettura informativa del sito.",
    sms: "Scrive campagne e flussi SMS.",
    social: "Pianifica e scrive contenuti social.",
    supabase: "Assistenza sull'uso di Supabase (DB, auth, RLS).",
    "supabase-postgres-best-practices": "Ottimizzazione e buone pratiche Postgres su Supabase.",
    superpowers: "Raccolta di capacità aggiuntive generiche per l'agente.",
    "systematic-debugging": "Metodo sistematico per il debugging.",
    tdd: "Sviluppo guidato dai test (test-driven development).",
    video: "Produzione video per marketing.",
    "web-design-guidelines": "Linee guida di design web.",
    "webapp-testing": "Test end-to-end di applicazioni web.",
    xlsx: "Crea, legge e modifica fogli di calcolo Excel.",
  },
