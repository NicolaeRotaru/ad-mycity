...
export const DESCRIZIONI = {
  ...
  skill: {
    ...
    // Le 67 skill sotto sono arrivate l'11-13/8 con un pacchetto di skill di marketing/ingegneria
    // pronte all'uso (plugin Anthropic): non sono mansionari scritti per MyCity, sono strumenti
    // generici che i senior possono richiamare quando il compito calza (copy, SEO, pricing, test...).
    "ab-testing": "Pianifica ed esegue A/B test ed esperimenti di crescita: ipotesi, varianti, durata, significatività statistica.",
    "ad-creative": "Genera e scala il testo degli annunci a pagamento — titoli, varianti, script — su qualunque piattaforma ads.",
    ads: "Strategia delle campagne a pagamento (Google/Meta/LinkedIn/TikTok): target, budget, ROAS/CPA, quando spegnere un annuncio.",
    "ai-seo": "Ottimizza i contenuti per farsi citare dai motori di ricerca AI (ChatGPT, Perplexity, AI Overviews).",
    analytics: "Imposta o verifica il tracciamento — GA4, eventi, UTM: la prima domanda quando serve misurare se qualcosa funziona.",
    aso: "Ottimizza una scheda App Store/Google Play: parole chiave, conversione della scheda, confronto con le app concorrenti.",
    "churn-prevention": "Riduce l'abbandono — flussi di cancellazione, offerte di salvataggio, recupero pagamenti falliti.",
    "co-marketing": "Trova partner per campagne congiunte con altre aziende — collaborazioni e cross-promozione.",
    "code-simplifier": "Semplifica e rifinisce codice appena scritto per chiarezza e manutenibilità, senza cambiarne il comportamento.",
    "codebase-design": "Vocabolario condiviso per progettare moduli — dove mettere un confine tra due pezzi di codice.",
    "codebase-search": "Esplora repository di codice remoti (Tabnine): domande cross-repo, impatto di una PR, uso reale di un'API esterna.",
    "cold-email": "Scrive email di prospezione a freddo B2B e le sequenze di follow-up che ottengono risposte.",
    "community-marketing": "Costruisce e fa leva su una community online (Discord/Slack/forum) per crescita e fedeltà al marchio.",
    "competitor-profiling": "Profila i concorrenti a partire dai loro siti — dossier strutturati su cosa fanno e come si posizionano.",
    competitors: "Crea pagine di confronto/alternativa a un concorrente, per SEO e per aiutare le vendite.",
    "content-strategy": "Decide cosa scrivere — argomenti, cluster tematici, calendario editoriale — prima del singolo pezzo.",
    "copy-editing": "Rilegge e migliora un testo di marketing già scritto, o lo aggiorna se è invecchiato — non lo riscrive da zero.",
    copywriting: "Scrive o riscrive il testo di marketing di una pagina — home, landing, prezzi: titoli, CTA, proposta di valore.",
    cro: "Ottimizza la conversione di una pagina o di un form — funnel, A/B test, frizioni nel checkout.",
    "customer-research": "Conduce e sintetizza ricerca sui clienti — interviste, recensioni, ticket di supporto, forum.",
    "diagnosing-bugs": "Il percorso per diagnosticare un bug difficile o un calo di prestazioni, prima di proporre una correzione.",
    "differential-review": "Revisione di sicurezza mirata su un diff/PR: raggio d'impatto, copertura dei test, regressioni.",
    "directory-submissions": "Invia il prodotto alle directory (Product Hunt, BetaList, directory AI/SaaS) per backlink e scoperta.",
    docx: "Crea, legge o modifica documenti Word (.docx) — report, lettere, template con formattazione professionale.",
    emails: "Costruisce sequenze email automatiche — benvenuto, nurture, riattivazione — per il ciclo di vita del cliente.",
    firecrawl: "Cerca e legge il web da riga di comando — ricerca, scraping di pagine, siti che richiedono click o login.",
    "free-tools": "Valuta o progetta uno strumento gratuito (calcolatore, generatore) come leva di marketing per generare contatti.",
    grilling: "Mette sotto torchio un piano o un'idea per farla resistere alle obiezioni, prima di eseguirla.",
    handoff: "Comprime la conversazione in corso in un documento di passaggio, perché un altro agente possa riprenderla.",
    image: "Genera o modifica immagini di marketing — grafiche social, mockup prodotto, banner — con strumenti AI.",
    launch: "Pianifica il lancio di un prodotto o di una funzione — checklist, Product Hunt, waitlist, annuncio.",
    "lead-magnets": "Progetta contenuti scaricabili (ebook, checklist, template) per raccogliere contatti email.",
    "marketing-council": "Simula un consiglio di grandi marketer (Godin, Ogilvy, Hormozi...) per pareri multipli e in contrasto.",
    "marketing-ideas": "Punto di partenza quando non si sa da dove cominciare — idee e strategie di marketing per prodotti software.",
    "marketing-loops": "Imposta un flusso di marketing ricorrente che gira da solo su un timer (revisione settimanale, controllo budget ads).",
    "marketing-plan": "Scrive un piano di marketing completo — acquisizione, attivazione, retention — su misura per stadio e budget.",
    "marketing-psychology": "Applica principi di psicologia e scienza comportamentale al marketing — perché le persone comprano.",
    offers: "Progetta l'offerta vera e propria — bonus, garanzie, urgenza, prezzo — quello che si vende, non solo come si scrive.",
    onboarding: "Ottimizza l'accoglienza dopo l'iscrizione — attivazione, primo valore percepito, perché chi si iscrive poi non resta.",
    paywalls: "Crea o ottimizza i muri a pagamento dentro il prodotto — schermate di upgrade, blocchi funzione.",
    pdf: "Legge, crea, unisce, divide o compila moduli PDF.",
    ponytail: "Solo task che toccano codice — scala a minimo indispensabile.",
    popups: "Crea o ottimizza popup, modali e banner per la conversione — exit-intent, raccolta email, annunci.",
    pricing: "Aiuta a decidere quanto far pagare e come strutturare i piani — soglie, freemium, prova gratuita.",
    "product-marketing": "Crea o aggiorna il documento di posizionamento del prodotto — chi è il cliente ideale, cosa lo distingue.",
    "programmatic-seo": "Crea pagine SEO su scala con template e dati — pagine per città/categoria/confronto generate in serie.",
    prospecting: "Trova e qualifica una lista di potenziali clienti da contattare.",
    "public-relations": "Comunicati stampa, contatti coi giornalisti, media kit — le pubbliche relazioni vere e proprie.",
    "react-best-practices": "Linee guida di prestazioni React/Next.js — da seguire quando si scrive o si rivede codice React.",
    referrals: "Progetta o analizza un programma di referral/affiliazione — passaparola a pagamento.",
    revops: "Le operazioni che collegano marketing e vendite — lead scoring, passaggio di consegne, igiene del CRM.",
    "sales-enablement": "Materiali per chi vende — pitch deck, one-pager, gestione obiezioni, script demo.",
    schema: "Aggiunge dati strutturati (schema.org/JSON-LD) a una pagina per i risultati arricchiti su Google.",
    "seo-audit": "Diagnosi degli errori SEO tecnici e on-page di un sito — punto di partenza quando «il traffico è calato».",
    signup: "Ottimizza il flusso di iscrizione/creazione account — dove si perdono le persone prima di entrare.",
    "site-architecture": "Pianifica la struttura delle pagine di un sito — gerarchia, URL, menu, link interni.",
    sms: "Pianifica campagne SMS/MMS — benvenuto, carrello abbandonato, promozionale, conformità.",
    social: "Crea, programma e ottimizza contenuti social (LinkedIn/Instagram/TikTok...) e fa ascolto sociale.",
    supabase: "Guida per qualunque lavoro su Supabase — database, autenticazione, RLS, funzioni edge, migrazioni.",
    "supabase-postgres-best-practices": "Buone pratiche Postgres di Supabase — query, schema, configurazione del database.",
    superpowers: "Il meccanismo che insegna a Claude a trovare e usare la skill giusta prima di rispondere.",
    "systematic-debugging": "Metodo per affrontare qualunque bug o comportamento inatteso, prima di proporre una correzione.",
    tdd: "Sviluppo guidato dai test — scrivere il test prima del codice, ciclo rosso-verde-rifattorizza.",
    video: "Crea o genera contenuti video con strumenti AI — avatar parlanti, video dimostrativi, pipeline programmatiche.",
    "web-design-guidelines": "Rivede il codice dell'interfaccia contro le linee guida di design web — accessibilità, coerenza visiva.",
    "webapp-testing": "Guida e testa un'app web locale con un browser vero (Playwright) — screenshot, log, verifica del comportamento.",
    xlsx: "Legge, crea o corregge fogli di calcolo (.xlsx/.csv) — formule, formattazione, pulizia di dati disordinati.",
    ...
    // «fantasma» ogni riga rimasta per un pezzo assente).
  },
