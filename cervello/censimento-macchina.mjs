...
export const DESCRIZIONI = {
  ...
  skill: {
    ...
    // ── Pacchetto skill di marketing/dev arrivato con un aggiornamento plugin (non scritte da noi,
    //    ma vanno spiegate lo stesso: un pezzo senza riga è un pezzo che nessuno sa che c'è).
