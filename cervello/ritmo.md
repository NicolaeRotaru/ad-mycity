...
6. 🔬 RICONCILIAZIONE PREFERENZE (auto-coscienza): allinea le preferenze_nicola con ciò che ha approvato/
   rifiutato davvero nella settimana (preference learning).
7. Proponi 1-2 miglioramenti a un mansionario (.claude/agents/) o 1 nuova sentinella, scegliendo i più
   sostenuti dall'evidenza (auto-riscrittura 🟡, le valida Nicola).
