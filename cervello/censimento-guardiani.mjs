...
export const DESCRIZIONI = {
  ...
  "adozione-medicine": { famiglia: "squadra", cosa: "Conta chi usa davvero le cure scritte nei lotti passati: una medicina che nessuno prende è una cura che esiste solo sulla carta." },
  ...
  "stash-dimenticate": { famiglia: "apprendimento", cosa: "Quando la macchina mette da parte del lavoro per fare spazio a un aggiornamento, quel lavoro deve tornare indietro: qui si contano le volte in cui non è tornato. Il 21/8 erano 7.849, accumulate al ritmo di una al minuto senza che nessuno guardasse." },
