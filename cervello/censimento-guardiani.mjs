...
export const DESCRIZIONI = {
  ...
  "correzione-nicola-gate": { famiglia: "apprendimento", cosa: "Conta quante correzioni di Nicola non hanno mai un freno automatico: farci più attenzione non basta, serve un gate che possa fallire." },
