#!/usr/bin/env node
// Capacità #27 — La Tesoreria di Rete. prevede i buchi di cassa dei negozi.
...
// Fonte dati (che userà): payout/incassi (Stripe + Bilancio Vivo).
...
const META = {
  n: 27, nome: "La Tesoreria di Rete", stato: "scaffold",
  cosa_fa: "prevede i buchi di cassa dei negozi", fonte_dati: "payout/incassi (Stripe + Bilancio Vivo)",
