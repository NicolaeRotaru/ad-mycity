#!/usr/bin/env node
// Capacità #7 — Il Genoma Replicabile. incolla il DNA sulla seconda città.
...
// Fonte dati (che userà): registro-realta + Blueprint (config città).
...
const META = {
  n: 7, nome: "Il Genoma Replicabile", stato: "scaffold",
  cosa_fa: "incolla il DNA sulla seconda città", fonte_dati: "registro-realta + Blueprint (config città)",
