#!/usr/bin/env node
// Capacità #16 — La Macchina che Insegna. micro-lezioni sui dati del singolo negozio.
...
// Fonte dati (che userà): marketplace REST (metriche del negozio).
...
const META = {
  n: 16, nome: "La Macchina che Insegna", stato: "scaffold",
  cosa_fa: "micro-lezioni sui dati del singolo negozio", fonte_dati: "marketplace REST (metriche del negozio)",
