#!/usr/bin/env node
// Capacità #26 — La Staffetta. logistica peer-to-peer tra negozi e rider.
...
// Fonte dati (che userà): ordini/consegne + zone.
...
const META = {
  n: 26, nome: "La Staffetta", stato: "scaffold",
  cosa_fa: "logistica peer-to-peer tra negozi e rider", fonte_dati: "ordini/consegne + zone",
