#!/usr/bin/env node
// Capacità #46 — Il Sistema Nervoso Fisico. IoT: frigo che si autodenuncia, contapersone, locker.
...
// Fonte dati (che userà): sensori IoT fisici.
...
const META = {
  n: 46, nome: "Il Sistema Nervoso Fisico", stato: "scaffold",
  cosa_fa: "IoT: frigo che si autodenuncia, contapersone, locker", fonte_dati: "sensori IoT fisici",
