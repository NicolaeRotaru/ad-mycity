#!/usr/bin/env node
// Capacità #53 — Il Compilatore d'Impresa. descrivi un'azienda a parole e la macchina la compila.
...
// Fonte dati (che userà): il genoma replicabile + Protocollo.
...
const META = {
  n: 53, nome: "Il Compilatore d'Impresa", stato: "scaffold",
  cosa_fa: "descrivi un'azienda a parole e la macchina la compila", fonte_dati: "il genoma replicabile + Protocollo",
