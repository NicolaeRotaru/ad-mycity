#!/usr/bin/env node
// Capacità #6 — L'Auto-espansione dell'Organico. prepara il 44° senior, lo prova, chiede la firma.
...
// Fonte dati (che userà): roster .claude/agents + keyword-owner-check.
...
const META = {
  n: 6, nome: "L'Auto-espansione dell'Organico", stato: "scaffold",
  cosa_fa: "prepara il 44° senior, lo prova, chiede la firma", fonte_dati: "roster .claude/agents + keyword-owner-check",
