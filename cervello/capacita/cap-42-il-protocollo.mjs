#!/usr/bin/env node
// Capacità #42 — Il Protocollo. standard aperto con cui gli agenti esterni si collegano.
...
// Fonte dati (che userà): API/registro partner (infrastruttura).
...
const META = {
  n: 42, nome: "Il Protocollo", stato: "scaffold",
  cosa_fa: "standard aperto con cui gli agenti esterni si collegano", fonte_dati: "API/registro partner (infrastruttura)",
