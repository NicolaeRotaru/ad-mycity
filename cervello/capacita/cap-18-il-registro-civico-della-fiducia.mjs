#!/usr/bin/env node
// Capacità #18 — Il Registro Civico della Fiducia. il badge «Verificato MyCity» come standard cittadino.
...
// Fonte dati (che userà): profili/recensioni marketplace REST.
...
const META = {
  n: 18, nome: "Il Registro Civico della Fiducia", stato: "scaffold",
  cosa_fa: "il badge «Verificato MyCity» come standard cittadino", fonte_dati: "profili/recensioni marketplace REST",
