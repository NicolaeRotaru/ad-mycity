#!/usr/bin/env node
// Capacità #48 — L'Onestà Dimostrabile. promesse verificabili matematicamente da terzi.
...
// Fonte dati (che userà): log/prove crittografiche.
...
const META = {
  n: 48, nome: "L'Onestà Dimostrabile", stato: "scaffold",
  cosa_fa: "promesse verificabili matematicamente da terzi", fonte_dati: "log/prove crittografiche",
