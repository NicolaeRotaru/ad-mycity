#!/usr/bin/env node
// Capacità #31 — Il Passaporto del Prodotto. provenienza e storia verificabile di ogni prodotto.
...
// Fonte dati (che userà): schede prodotto marketplace REST.
...
const META = {
  n: 31, nome: "Il Passaporto del Prodotto", stato: "scaffold",
  cosa_fa: "provenienza e storia verificabile di ogni prodotto", fonte_dati: "schede prodotto marketplace REST",
