#!/usr/bin/env node
// Capacità #2 — Un mini-AD per ogni negoziante. il negoziante scrive su WhatsApp e il suo assistente aggiorna catalogo/foto.
...
// Fonte dati (che userà): marketplace REST (catalogo del negozio) + WhatsApp.
...
const META = {
  n: 2, nome: "Un mini-AD per ogni negoziante", stato: "scaffold",
  cosa_fa: "il negoziante scrive su WhatsApp e il suo assistente aggiorna catalogo/foto", fonte_dati: "marketplace REST (catalogo del negozio) + WhatsApp",
