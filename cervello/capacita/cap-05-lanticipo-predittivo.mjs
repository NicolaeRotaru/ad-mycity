#!/usr/bin/env node
// Capacità #5 — L'Anticipo Predittivo. domanda prevista per negozio per fascia oraria.
...
// Fonte dati (che userà): storico ordini per negozio/ora.
...
const META = {
  n: 5, nome: "L'Anticipo Predittivo", stato: "scaffold",
  cosa_fa: "domanda prevista per negozio per fascia oraria", fonte_dati: "storico ordini per negozio/ora",
