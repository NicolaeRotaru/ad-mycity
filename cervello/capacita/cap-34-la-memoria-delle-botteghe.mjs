#!/usr/bin/env node
// Capacità #34 — La Memoria delle Botteghe. il sapere delle botteghe conservato per la successione.
...
// Fonte dati (che userà): consenso + contenuti del bottegaio.
...
const META = {
  n: 34, nome: "La Memoria delle Botteghe", stato: "scaffold",
  cosa_fa: "il sapere delle botteghe conservato per la successione", fonte_dati: "consenso + contenuti del bottegaio",
