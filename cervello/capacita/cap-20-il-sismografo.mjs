#!/usr/bin/env node
// Capacità #20 — Il Sismografo. segnali deboli di churn da login e attività.
...
// Fonte dati (che userà): attività/login clienti marketplace REST.
...
const META = {
  n: 20, nome: "Il Sismografo", stato: "scaffold",
  cosa_fa: "segnali deboli di churn da login e attività", fonte_dati: "attività/login clienti marketplace REST",
