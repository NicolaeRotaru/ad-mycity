#!/usr/bin/env node
// Capacità #44 — La Mutua Algoritmica. rischio condiviso nella rete (gate regolamentare).
...
// Fonte dati (che userà): storico sinistri/rischi + partner.
...
const META = {
  n: 44, nome: "La Mutua Algoritmica", stato: "scaffold",
  cosa_fa: "rischio condiviso nella rete (gate regolamentare)", fonte_dati: "storico sinistri/rischi + partner",
