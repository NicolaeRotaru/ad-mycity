#!/usr/bin/env node
// Capacità #11 — La Spesa che si Riordina da Sola. riordino previsto, un tap del cliente per confermare.
...
// Fonte dati (che userà): storico ordini per cliente.
...
const META = {
  n: 11, nome: "La Spesa che si Riordina da Sola", stato: "scaffold",
  cosa_fa: "riordino previsto, un tap del cliente per confermare", fonte_dati: "storico ordini per cliente",
