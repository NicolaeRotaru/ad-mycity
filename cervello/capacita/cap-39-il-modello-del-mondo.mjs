#!/usr/bin/env node
// Capacità #39 — Il Modello del Mondo. modello vivo di Piacenza che risponde ai controfattuali.
...
// Fonte dati (che userà): ≥12 mesi di storico multi-fonte.
...
const META = {
  n: 39, nome: "Il Modello del Mondo", stato: "scaffold",
  cosa_fa: "modello vivo di Piacenza che risponde ai controfattuali", fonte_dati: "≥12 mesi di storico multi-fonte",
