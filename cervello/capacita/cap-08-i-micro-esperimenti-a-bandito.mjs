#!/usr/bin/env node
// Capacità #8 — I Micro-esperimenti a Bandito. il budget si auto-alloca su ciò che rende.
...
// Fonte dati (che userà): esperimenti-check + Bilancio Vivo.
...
const META = {
  n: 8, nome: "I Micro-esperimenti a Bandito", stato: "scaffold",
  cosa_fa: "il budget si auto-alloca su ciò che rende", fonte_dati: "esperimenti-check + Bilancio Vivo",
