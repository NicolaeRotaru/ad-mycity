#!/usr/bin/env node
// Capacità #9 — Il Catasto Vivo della Domanda. mappa della domanda inespressa → chi reclutare.
...
// Fonte dati (che userà): ricerche/carrelli/lead marketplace REST.
...
const META = {
  n: 9, nome: "Il Catasto Vivo della Domanda", stato: "scaffold",
  cosa_fa: "mappa della domanda inespressa → chi reclutare", fonte_dati: "ricerche/carrelli/lead marketplace REST",
