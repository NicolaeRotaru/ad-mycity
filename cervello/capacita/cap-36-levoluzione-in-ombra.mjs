#!/usr/bin/env node
// Capacità #36 — L'Evoluzione in Ombra. varianti di sé in shadow sui dati veri.
...
// Fonte dati (che userà): storico giri/decisioni (banco-ai).
...
const META = {
  n: 36, nome: "L'Evoluzione in Ombra", stato: "scaffold",
  cosa_fa: "varianti di sé in shadow sui dati veri", fonte_dati: "storico giri/decisioni (banco-ai)",
