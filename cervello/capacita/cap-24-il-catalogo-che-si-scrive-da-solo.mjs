#!/usr/bin/env node
// Capacità #24 — Il Catalogo che si Scrive da Solo. foto dello scaffale → schede e prezzi proposti.
...
// Fonte dati (che userà): foto/catalogo del negozio (supervisione-negozi).
...
const META = {
  n: 24, nome: "Il Catalogo che si Scrive da Solo", stato: "scaffold",
  cosa_fa: "foto dello scaffale → schede e prezzi proposti", fonte_dati: "foto/catalogo del negozio (supervisione-negozi)",
