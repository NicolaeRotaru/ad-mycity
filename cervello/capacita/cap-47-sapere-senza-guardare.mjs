#!/usr/bin/env node
// Capacità #47 — Sapere senza Guardare. apprendimento federato + privacy differenziale.
...
// Fonte dati (che userà): dati federati dei negozi (privacy).
...
const META = {
  n: 47, nome: "Sapere senza Guardare", stato: "scaffold",
  cosa_fa: "apprendimento federato + privacy differenziale", fonte_dati: "dati federati dei negozi (privacy)",
