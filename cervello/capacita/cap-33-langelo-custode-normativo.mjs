#!/usr/bin/env node
// Capacità #33 — L'Angelo Custode Normativo. HACCP/fisco/GDPR vegliati, avviso prima della multa.
...
// Fonte dati (che userà): scadenze/compliance dei negozi (legale).
...
const META = {
  n: 33, nome: "L'Angelo Custode Normativo", stato: "scaffold",
  cosa_fa: "HACCP/fisco/GDPR vegliati, avviso prima della multa", fonte_dati: "scadenze/compliance dei negozi (legale)",
