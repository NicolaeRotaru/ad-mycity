#!/usr/bin/env node
// Capacità #21 — L'Almanacco. la memoria stagionale e ricorrente della domanda.
...
// Fonte dati (che userà): storico ordini + eventi-picchi.
...
const META = {
  n: 21, nome: "L'Almanacco", stato: "scaffold",
  cosa_fa: "la memoria stagionale e ricorrente della domanda", fonte_dati: "storico ordini + eventi-picchi",
