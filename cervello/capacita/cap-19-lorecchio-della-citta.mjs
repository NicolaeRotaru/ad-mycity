#!/usr/bin/env node
// Capacità #19 — L'Orecchio della Città. ascolta i segnali pubblici della città (gate legale-privacy).
...
// Fonte dati (che userà): fonti web (sentinella-fonti) + parere legale.
...
const META = {
  n: 19, nome: "L'Orecchio della Città", stato: "scaffold",
  cosa_fa: "ascolta i segnali pubblici della città (gate legale-privacy)", fonte_dati: "fonti web (sentinella-fonti) + parere legale",
