#!/usr/bin/env node
// Capacità #50 — La Macchina che fa Ricerca su Sé Stessa. legge le novità AI e propone upgrade della propria architettura.
...
// Fonte dati (che userà): auto-radiografia + storico salute.
...
const META = {
  n: 50, nome: "La Macchina che fa Ricerca su Sé Stessa", stato: "scaffold",
  cosa_fa: "legge le novità AI e propone upgrade della propria architettura", fonte_dati: "auto-radiografia + storico salute",
