#!/usr/bin/env node
// Capacità #52 — La Pianificazione Generazionale. strategie a orizzonte 2040 portate avanti senza dimenticare.
...
// Fonte dati (che userà): memoria di lungo periodo.
...
const META = {
  n: 52, nome: "La Pianificazione Generazionale", stato: "scaffold",
  cosa_fa: "strategie a orizzonte 2040 portate avanti senza dimenticare", fonte_dati: "memoria di lungo periodo",
