#!/usr/bin/env node
// Capacità #22 — Il Consiglio dei Piacentini. panel simulato di cittadini per testare le mosse (gate legale).
...
// Fonte dati (che userà): profili aggregati + parere legale.
...
const META = {
  n: 22, nome: "Il Consiglio dei Piacentini", stato: "scaffold",
  cosa_fa: "panel simulato di cittadini per testare le mosse (gate legale)", fonte_dati: "profili aggregati + parere legale",
