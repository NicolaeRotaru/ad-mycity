#!/usr/bin/env node
// Capacità #32 — Il Quotidiano del Commercio. il racconto settimanale generato dai dati veri.
...
// Fonte dati (che userà): KPI di rete (analista) + eventi.
...
const META = {
  n: 32, nome: "Il Quotidiano del Commercio", stato: "scaffold",
  cosa_fa: "il racconto settimanale generato dai dati veri", fonte_dati: "KPI di rete (analista) + eventi",
