#!/usr/bin/env node
// Capacità #29 — Il Dividendo del Volano. redistribuisce il valore creato dalla rete.
...
// Fonte dati (che userà): margini di rete (Bilancio Vivo).
...
const META = {
  n: 29, nome: "Il Dividendo del Volano", stato: "scaffold",
  cosa_fa: "redistribuisce il valore creato dalla rete", fonte_dati: "margini di rete (Bilancio Vivo)",
