#!/usr/bin/env node
// Capacità #28 — Il Gruppo d'Acquisto Autonomo. aggrega e negozia bozze d'acquisto da grande.
...
// Fonte dati (che userà): acquisti/fornitori dei negozi.
...
const META = {
  n: 28, nome: "Il Gruppo d'Acquisto Autonomo", stato: "scaffold",
  cosa_fa: "aggrega e negozia bozze d'acquisto da grande", fonte_dati: "acquisti/fornitori dei negozi",
