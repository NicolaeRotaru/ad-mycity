#!/usr/bin/env node
// Capacità #10 — La Camera di Negoziazione delle Botteghe. gli agenti negoziano bozze di bundle win-win.
...
// Fonte dati (che userà): cataloghi/margini dei negozi (Bilancio Vivo).
...
const META = {
  n: 10, nome: "La Camera di Negoziazione delle Botteghe", stato: "scaffold",
  cosa_fa: "gli agenti negoziano bozze di bundle win-win", fonte_dati: "cataloghi/margini dei negozi (Bilancio Vivo)",
