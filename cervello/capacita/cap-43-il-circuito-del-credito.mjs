#!/usr/bin/env node
// Capacità #43 — Il Circuito del Credito. liquidità condivisa nella rete (gate regolamentare).
...
// Fonte dati (che userà): tesoreria di rete + partner autorizzati.
...
const META = {
  n: 43, nome: "Il Circuito del Credito", stato: "scaffold",
  cosa_fa: "liquidità condivisa nella rete (gate regolamentare)", fonte_dati: "tesoreria di rete + partner autorizzati",
