#!/usr/bin/env node
// Capacità #49 — Un Agente per Ogni Cittadino. ogni piacentino col suo agente che negozia con la rete.
...
// Fonte dati (che userà): identità/agenti cittadini.
...
const META = {
  n: 49, nome: "Un Agente per Ogni Cittadino", stato: "scaffold",
  cosa_fa: "ogni piacentino col suo agente che negozia con la rete", fonte_dati: "identità/agenti cittadini",
