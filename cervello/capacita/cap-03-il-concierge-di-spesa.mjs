#!/usr/bin/env node
// Capacità #3 — Il Concierge di Spesa. una frase → carrello multi-negozio composto.
...
// Fonte dati (che userà): marketplace REST (prodotti di più negozi).
...
const META = {
  n: 3, nome: "Il Concierge di Spesa", stato: "scaffold",
  cosa_fa: "una frase → carrello multi-negozio composto", fonte_dati: "marketplace REST (prodotti di più negozi)",
