#!/usr/bin/env node
// Capacità #15 — Le Squadre-Lampo. task-force temporanee su un evento, poi si sciolgono.
...
// Fonte dati (che userà): eventi-picchi + sentinelle.
...
const META = {
  n: 15, nome: "Le Squadre-Lampo", stato: "scaffold",
  cosa_fa: "task-force temporanee su un evento, poi si sciolgono", fonte_dati: "eventi-picchi + sentinelle",
