#!/usr/bin/env node
// Capacità #1 — Il Gemello Digitale. simula una mossa (e l'azienda) prima di farla.
...
// Fonte dati (che userà): storico ordini/decisioni + Bilancio Vivo.
...
const META = {
  n: 1, nome: "Il Gemello Digitale", stato: "scaffold",
  cosa_fa: "simula una mossa (e l'azienda) prima di farla", fonte_dati: "storico ordini/decisioni + Bilancio Vivo",
