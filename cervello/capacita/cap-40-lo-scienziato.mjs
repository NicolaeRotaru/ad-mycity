#!/usr/bin/env node
// Capacità #40 — Lo Scienziato. motore causale: ipotesi → esperimenti → leggi locali.
...
// Fonte dati (che userà): storico esperimenti + coorti.
...
const META = {
  n: 40, nome: "Lo Scienziato", stato: "scaffold",
  cosa_fa: "motore causale: ipotesi → esperimenti → leggi locali", fonte_dati: "storico esperimenti + coorti",
