#!/usr/bin/env node
// Capacità #17 — Il Prezzo Onesto Dinamico. prezzi che si muovono e si spiegano in chiaro.
...
// Fonte dati (che userà): domanda + margini (Bilancio Vivo).
...
const META = {
  n: 17, nome: "Il Prezzo Onesto Dinamico", stato: "scaffold",
  cosa_fa: "prezzi che si muovono e si spiegano in chiaro", fonte_dati: "domanda + margini (Bilancio Vivo)",
