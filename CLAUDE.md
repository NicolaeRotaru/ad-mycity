...
- 🚢 **devops-sre** — deploy, CI, Render, log, env, uptime, rollback, errori di produzione (→ architettura dei servizi, scalabilità e costo del cloud = **platform-infra**; monitoraggio di sicurezza, incidenti e vulnerabilità = **infosec-soc**; suite di test automatici e regressione = **sdet**)
